...
public class MandelbrotTenth extends Julia {
  private MandelVariation type;
    ...
    public MandelbrotTenth(double xCenter, double yCenter, double size, int max_iterations, double bailout, int out_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals, boolean burning_ship) {
    ...
    public MandelbrotTenth(double xCenter, double yCenter, double size, int max_iterations, double bailout, int out_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean burning_ship, double xJuliaCenter, double yJuliaCenter) {
    ...
    //orbit
    public MandelbrotTenth(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals, boolean burning_ship) {
    ...
    public MandelbrotTenth(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean burning_ship, double xJuliaCenter, double yJuliaCenter) {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = type.getPixel(complex[0]).tenth().plus(complex[1]);
