...
public class CosArgDivideNormAverage extends GenericStatistic {
    ...
    public CosArgDivideNormAverage(double statistic_intensity, double StripeDensity, double log_bailout_squared, double bailout, boolean useSmoothing, boolean useAverage, int lastXItems) {
