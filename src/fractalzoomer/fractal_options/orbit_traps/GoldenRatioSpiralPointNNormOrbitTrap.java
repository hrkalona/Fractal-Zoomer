...
public class GoldenRatioSpiralPointNNormOrbitTrap extends OrbitTrap {
    ...
    public GoldenRatioSpiralPointNNormOrbitTrap(double pointRe, double pointIm, double trapLength, double trapWidth, double n_norm, boolean countTrapIterations) {
