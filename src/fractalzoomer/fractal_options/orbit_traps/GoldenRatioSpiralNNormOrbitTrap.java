...
public class GoldenRatioSpiralNNormOrbitTrap extends OrbitTrap {
    ...
    public GoldenRatioSpiralNNormOrbitTrap(double pointRe, double pointIm, double trapLength, double trapWidth, double n_norm) {
    ...
    public void check(Complex val) {
        ...
        dist = dist = Math.abs(temp.nnorm(n_norm) - trapLength);
