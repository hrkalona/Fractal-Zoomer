    ...
    public void overview(Settings s, boolean periodicity_checking) {
        ...
        if (!s.useDirectColor) {
            ...
            if (!s.ds.domain_coloring && s.usePaletteForInColoring) {
                ...
                JButton saveBasicSettings = new MyButton("Export Basic Settings");

                saveBasicSettings.setToolTipText("Exports some basic location settings into json format.");
                saveBasicSettings.setFocusable(false);
                saveBasicSettings.setIcon(MainWindow.getIcon("export.png"));
                saveBasicSettings.setPreferredSize(new Dimension(150, 32));

                saveBasicSettings.addActionListener(e -> MainWindow.exportBasicSettings(s, parent));
