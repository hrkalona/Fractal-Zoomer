...
public class FunctionUserMultiArgumentExpressionNode implements ExpressionNode {
    ...
    public static final int M_FUNCS = 60; //number of m functions
    public static final String FUNC_NAME = "m";
    ...
    public Complex getValue() {
        ...
        try {
            return lambda.m(arguments[0].getValue(), arguments[1].getValue(), arguments[2].getValue(), arguments[3].getValue(), arguments[4].getValue(), arguments[5].getValue(), arguments[6].getValue(), arguments[7].getValue(), arguments[8].getValue(), arguments[9].getValue());
        } catch (Exception ex) {
            return new Complex();
        }
    ...
    private void createUserFunction() {
        ...
        try {
            Method method = Parser.userClass.getDeclaredMethod(FUNC_NAME + (function + 1), Complex.class, Complex.class, Complex.class, Complex.class, Complex.class, Complex.class, Complex.class, Complex.class, Complex.class, Complex.class);
