...
public class PerturbationTheoryHelpDialog {
        ...
        String overview = "<font size='5' face='arial' color='blue'><center><b><u>Perturbation Theory</u></b></center></font><br><br>"
                + "<font  face='arial'>This technique let us zoom in deeper areas (deeper than 1e-13), where the normal double precision " +
                ...
                "Built-in BigNum is a fixed precision floating point implementation, which is faster than Apfloat arbitrary precision implementation. " +
                "Fixed Point BigInteger BigNum is a fixed precision floating point implementation, based on BigInteger. " +
                ...
                "The automatic option will try to pick the best implementation depending on the depth and bit precision. " +
                "BigNum Libraries can be used for reference point calculation and pixel to coordinate mapping.<br><br>" +
                ...
                "Bilinear Approximation (Zhuoran's) has similarities with first version of BLA but it is faster. Currently it is only implemented for Mandelbrot (Not with burning ship or Julia sets).<br><br>" +

                "Nanomb1 can skip multiples of the period, and its only implemented for Mandelbrot (2) (Not supported with burning ship or Julia sets).<br><br>" +
                ...
                "or switch back to double precision when is appropriate.<br>" +
