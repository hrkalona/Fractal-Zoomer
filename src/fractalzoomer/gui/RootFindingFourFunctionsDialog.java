 ...
 * @author hrkalona2
 */
public class RootFindingFourFunctionsDialog extends JDialog {
    ...
    public RootFindingFourFunctionsDialog(MainWindow ptr, Settings s, int oldSelected, JRadioButtonMenuItem[] fractal_functions, boolean wasMagnetType, boolean wasConvergingType, boolean wasSimpleType, boolean wasMagneticPendulumType, boolean wasEscapingOrConvergingType) {
        ...
        JTextField field_dddfz_formula2 = new JTextField(50);
        field_dddfz_formula2.setText(f4);
        ...
        JPanel formula_dddfz_panel2 = new JPanel();

        formula_dddfz_panel2.add(new JLabel("f'''(z) ="));
        formula_dddfz_panel2.add(field_dddfz_formula2);

        JLabel imagelabel41 = new JLabel();

        if (s.fns.function == HOUSEHOLDER3FORMULA) {
            imagelabel41.setIcon(MainWindow.getIcon("householder3.png"));
        } else if (s.fns.function == ABBASBANDYFORMULA) {
            imagelabel41.setIcon(MainWindow.getIcon("abbasbandy.png"));
        }
        else if (s.fns.function == ABBASBANDY3FORMULA) {
            imagelabel41.setIcon(MainWindow.getIcon("abbasbandy3.png"));
        }
        ...
        formula_dddfz_panel2.setVisible(s.fns.derivative_method == Derivative.DISABLED);
        ...
        derivative_choice.addActionListener(e -> {
            ...
            formula_dddfz_panel2.setVisible(derivative_choice.getSelectedIndex() == Derivative.DISABLED);
            pack();
        });
                ...
                e -> {
                    ...
                    if (isVisible() && (e.getSource() == optionPane) && (prop.equals(JOptionPane.VALUE_PROPERTY))) {
                        ...
                        try {
                            ...
                            s.parser.parse(field_dddfz_formula2.getText());
                            ...
                            s.fns.user_dddfz_formula = field_dddfz_formula2.getText();
