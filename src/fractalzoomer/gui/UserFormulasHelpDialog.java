...
public class UserFormulasHelpDialog {
    ...
    public UserFormulasHelpDialog(MainPanel main_panel, JScrollPane scroll_pane) {
        ...
        String overview = "<font size='5' face='arial' color='blue'><center><b><u>User Formulas</u></b></center></font><br><br>"
                ...
                + "<font  face='arial'><font size='5' face='arial'>&#8226;</font><font color='red'><b>v10</b></font>: placeholder variable 10.<br><br>"
                ...
                + "<font  face='arial'><font size='5' face='arial'>&#8226;</font><font color='red'><b>f20</b></font>: user function f20 which can be changed in UserDefinedFunctions.java (Compilation is required).<br><br>"
                + "The f1 - f20 functions are focused on experienced users<br>"
                ...
                + "<font  face='arial'><font size='5' face='arial'>&#8226;</font><font color='red'><b>g20</b></font>: user function g20 which can be changed in UserDefinedFunctions.java (Compilation is required).<br><br>"
                + "The g1 - g20 functions are focused on experienced users<br>"
                + "that might have some computer science background.<br><br><br>"
                ...
                + "<font  face='arial'><font size='5' face='arial'>&#8226;</font><font color='red'><b>m20</b></font>: user function m20 which can be changed in UserDefinedFunctions.java (Compilation is required).<br><br>"
                + "The m1 - m20 functions are focused on experienced users<br>"
                + "that might have some computer science background.<br><br><br>"
