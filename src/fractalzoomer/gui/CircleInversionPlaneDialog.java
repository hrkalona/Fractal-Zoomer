 ...
 * @author hrkalona2
 */
public class CircleInversionPlaneDialog extends JDialog {

    private MainWindow ptra;
    private JOptionPane optionPane;

    public CircleInversionPlaneDialog(MainWindow ptr, Settings s, int oldSelected, JRadioButtonMenuItem[] planes) {

        super(ptr);
        
        ptra = ptr;

        setTitle("Circle Inversion");
        setModal(true);
            ...
            public void propertyChange(PropertyChangeEvent e) {
                ...
                if (isVisible() && (e.getSource() == optionPane) && (prop.equals(JOptionPane.VALUE_PROPERTY))) {
                    ...
                    try {
                        ...
                        if (temp4 <= 0) {
                            JOptionPane.showMessageDialog(ptra, "Circle inversion radius must be greater than 0.", "Error!", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
