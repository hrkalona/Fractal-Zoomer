...
public class InColoringFormulaDialog extends JDialog {
    ...
    public InColoringFormulaDialog(MainWindow ptr, Settings s, int oldSelected, JRadioButtonMenuItem[] in_coloring_modes) {
        ...
        Object[] labels3 = ptra.createUserFormulaLabels("z, c, s, p, pp, n, maxn, bail, cbail, center, size, sizei, v1 - v30, point");
                ...
                if (isVisible() && (e.getSource() == optionPane) && (prop.equals(JOptionPane.VALUE_PROPERTY))) {
                    ...
                    try {
                        if (tabbedPane.getSelectedIndex() == 0) {
                            ...
                            if(s.parser.foundR()) {
                                JOptionPane.showMessageDialog(ptra, "The variable: r cannot be used in the in formula.", "Error!", JOptionPane.ERROR_MESSAGE);
                                return;
                            }
                            ...
                            if(s.parser.foundR()) {
                                JOptionPane.showMessageDialog(ptra, "The variable: r cannot be used in the left > right in formula.", "Error!", JOptionPane.ERROR_MESSAGE);
                                return;
                            }
