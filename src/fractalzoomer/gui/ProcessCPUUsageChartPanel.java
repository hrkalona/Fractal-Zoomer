...
public class ProcessCPUUsageChartPanel extends JPanel {
    private final TimeSeries cpu_usage;

    public ProcessCPUUsageChartPanel(int maxAge) {
        ...
        JFreeChart chart = new JFreeChart("Application CPU Usage", plot);

        ChartUtils.applyCurrentTheme(chart);

        Color green = new Color(11, 102, 35);
        double coef = 0.6;
