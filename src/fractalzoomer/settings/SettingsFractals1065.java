...
public class SettingsFractals1065 extends SettingsFractals1064 implements Serializable {
    ...
    public int getColorSmoothingMethod() {
        
        return color_smoothing_method;
        
    }
    
    public int[] getFiltersOrder() {
        
        return filters_order;
        
    }
    
    public double getBumpMappingNoiseReducingFactor() {
        
        return bm_noise_reducing_factor;
