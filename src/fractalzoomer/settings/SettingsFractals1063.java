...
public class SettingsFractals1063 extends SettingsFractals1062 implements Serializable {
    ...
    public Color[] getFiltersColors() {
        
        return filters_colors;
        
    }
    
    public String[] getUserFormulaCoupled() {
        
        return user_formula_coupled;
    ...
    public double getCouplingAmplitude() {
        
        return coupling_amplitude;
        
    }
    
    public double getCouplingFrequency() {
        
        return coupling_frequency;
        
    }
    
    public int getCouplingSeed() {
        
        return coupling_seed;
        
    }
    
    public int getCouplingMethod() {
        
        return coupling_method;
    ...
    public boolean getUsePaletteDomainColoring() {
        
        return use_palette_domain_coloring;
