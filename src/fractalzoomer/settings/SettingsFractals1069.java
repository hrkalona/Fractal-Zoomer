...
public class SettingsFractals1069 extends SettingsFractals1068 implements Serializable {
    ...
    public boolean getContourColoring() {
        return contour_coloring;
    }

    public double getContourColoringNoiseReducingFactor() {
        return cn_noise_reducing_factor;
    }

    public double getContourColoringBlending() {
        return cn_blending;
    }

    public int getContourColoringAlgorithm() {
        return contour_algorithm;
    }

    public boolean getDirectColor() {
        return direct_color;
    }

    public double[] getKleinianLine() {
        return kleinianLine;
    }

    public double getKleinianK() {
        return kleinianK;
    }

    public double getKleinianM() {
        return kleinianM;
    }
