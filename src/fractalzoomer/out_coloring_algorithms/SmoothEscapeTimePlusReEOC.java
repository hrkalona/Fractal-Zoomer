 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimePlusReEOC extends OutColorAlgorithm {

    protected double log_convergent_bailout;
    protected int algorithm;

    public SmoothEscapeTimePlusReEOC(double log_convergent_bailout, int algorithm) {
    ...
    public double getResult(Object[] object) {
        ...
        return Math.abs(((Integer)object[0]) + ((Complex)object[1]).getRe() + temp3);
