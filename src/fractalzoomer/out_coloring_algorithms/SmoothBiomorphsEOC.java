 ...
 * @author hrkalona2
 */
public class SmoothBiomorphsEOC extends SmoothBiomorphs {

    protected double log_convergent_bailout;
    protected int algorithm2;

    public SmoothBiomorphsEOC(double log_bailout_squared, double log_convergent_bailout, double bailout, int algorithm, int algorithm2) {
