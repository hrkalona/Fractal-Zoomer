 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeFieldLinesEOC extends SmoothEscapeTimeFieldLines {

    private double log_convergent_bailout;
    private int algorithm2;

    public SmoothEscapeTimeFieldLinesEOC(double bailout, double log_bailout_squared, double log_convergent_bailout, int algorithm, int algorithm2) {
    ...
    public double getResult(Object[] object) {
        ...
        if((boolean)object[8]) {
            ...
            if(algorithm2 == 0) {
                ...
                double f = SmoothEscapeTimeEOC.getConvSmoothing2(object, log_convergent_bailout);
