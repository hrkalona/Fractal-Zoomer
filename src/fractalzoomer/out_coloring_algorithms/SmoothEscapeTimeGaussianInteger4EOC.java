 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeGaussianInteger4EOC extends OutColorAlgorithm {

    protected double log_convergent_bailout;
    protected int algorithm;

    public SmoothEscapeTimeGaussianInteger4EOC(double log_convergent_bailout, int algorithm) {
    ...
    public double getResult(Object[] object) {
        ...
        return Math.abs((Integer)object[0] + temp.getRe() + temp.getIm() + temp3);
