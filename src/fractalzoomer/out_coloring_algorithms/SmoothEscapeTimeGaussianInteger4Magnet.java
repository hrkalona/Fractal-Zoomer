...
public class SmoothEscapeTimeGaussianInteger4Magnet extends OutColorAlgorithm {
    ...
    public SmoothEscapeTimeGaussianInteger4Magnet(double log_convergent_bailout, int algorithm) {
    ...
    public double getResult(Object[] object) {
        ...
        return Math.abs((Integer)object[0] + temp.getRe() + temp.getIm() + temp3) + MAGIC_OFFSET_NUMBER;
