 ...
 * @author hrkalona2
 */
public class SmoothBinaryDecompositionRootFindingMethod extends SmoothBinaryDecomposition {
  protected double log_convergent_bailout;

    public SmoothBinaryDecompositionRootFindingMethod(double log_convergent_bailout) {
