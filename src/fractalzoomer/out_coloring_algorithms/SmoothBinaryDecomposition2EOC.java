 ...
 * @author hrkalona2
 */
public class SmoothBinaryDecomposition2EOC extends SmoothBinaryDecomposition2 {
  protected double log_convergent_bailout;
  protected int algorithm2;

    public SmoothBinaryDecomposition2EOC(double log_bailout_squared, double log_convergent_bailout, int algorithm, int algorithm2) {
    ...
    public double getResult(Object[] object) {
        ...
        if((Boolean)object[8]) {
            ...
            if(algorithm2 == 0) {
                ...
                temp3 = (Integer)object[0] + (log_convergent_bailout - temp) / (Math.log(((Complex)object[1]).distance_squared((Complex)object[2])) - temp);
            }
            else {
