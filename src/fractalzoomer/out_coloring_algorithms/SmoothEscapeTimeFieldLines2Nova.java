 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeFieldLines2Nova extends OutColorAlgorithm {

    private double log_convergent_bailout;
    protected double log_bailout_squared;
    protected int algorithm;

    public SmoothEscapeTimeFieldLines2Nova(double log_convergent_bailout, int algorithm) {
