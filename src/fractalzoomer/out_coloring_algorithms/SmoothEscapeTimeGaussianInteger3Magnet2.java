 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeGaussianInteger3Magnet2 extends OutColorAlgorithm {
  protected double log_convergent_bailout;

    
    public SmoothEscapeTimeGaussianInteger3Magnet2(double log_convergent_bailout) {
