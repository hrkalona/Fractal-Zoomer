 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeGaussianIntegerEOC extends OutColorAlgorithm {

    protected double log_convergent_bailout;
    protected int algorithm;

    public SmoothEscapeTimeGaussianIntegerEOC(double log_convergent_bailout, int algorithm) {
