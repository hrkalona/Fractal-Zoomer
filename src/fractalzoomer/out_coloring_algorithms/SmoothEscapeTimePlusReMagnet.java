...
public class SmoothEscapeTimePlusReMagnet extends OutColorAlgorithm {
    ...
    public SmoothEscapeTimePlusReMagnet(double log_convergent_bailout, int algorithm) {
    ...
    public double getResult(Object[] object) {
        ...
        return Math.abs(((Integer)object[0]) + ((Complex)object[1]).getRe() + temp3) + MAGIC_OFFSET_NUMBER;
