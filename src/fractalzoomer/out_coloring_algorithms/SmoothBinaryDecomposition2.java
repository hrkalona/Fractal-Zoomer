...
public class SmoothBinaryDecomposition2 extends OutColorAlgorithm {
    ...
    public SmoothBinaryDecomposition2(double bailout, double log_bailout_squared, int algorithm) {
    ...
    public SmoothBinaryDecomposition2(double bailout, double log_bailout_squared, int algorithm, double log_power) {
