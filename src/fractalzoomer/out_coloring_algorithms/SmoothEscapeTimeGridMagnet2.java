 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeGridMagnet2 extends SmoothEscapeTimeGrid {
  private double log_convergent_bailout;
    
    public SmoothEscapeTimeGridMagnet2(double log_bailout_squared, double log_convergent_bailout) {
