...
public class EdgeFilter extends WholeImageFilter {
	...
	public float[] getHEdgeMatrix() {
        ...
        public void setHorizontalAlgorithm(int val) {
            ...
            switch (val) {
                case 0:
                    ...
                    break;
                case 1:
                    hEdgeMatrix = ROBERTS_H;
                    break;
                case 2:
                    hEdgeMatrix = PREWITT_H;
                    break;
                case 3:
                    hEdgeMatrix = FREI_CHEN_H;
                    break;
            }
        }
        
        public void setVerticalAlgorithm(int val) {
            ...
            switch (val) {
                case 0:
                    ...
                    break;
                case 1:
                    vEdgeMatrix = ROBERTS_V;
                    break;
                case 2:
                    vEdgeMatrix = PREWITT_V;
                    break;
                case 3:
                    vEdgeMatrix = FREI_CHEN_V;
                    break;
            }
        }
