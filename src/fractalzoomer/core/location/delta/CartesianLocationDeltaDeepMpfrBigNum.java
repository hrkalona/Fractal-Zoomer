...
public class CartesianLocationDeltaDeepMpfrBigNum extends CartesianLocationDeltaGenericMpfrBigNum {
    ...
    public CartesianLocationDeltaDeepMpfrBigNum(Apfloat xCenter, Apfloat yCenter, Apfloat size, double height_ratio, int image_size, Apfloat[] rotation_center, Apfloat[] rotation_vals, Fractal fractal, JitterSettings js) {
