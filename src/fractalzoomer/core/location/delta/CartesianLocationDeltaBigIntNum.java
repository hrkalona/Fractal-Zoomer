...
public class CartesianLocationDeltaBigIntNum extends CartesianLocationDeltaGenericBigIntNum {

    public CartesianLocationDeltaBigIntNum(Apfloat xCenter, Apfloat yCenter, Apfloat size, double height_ratio, int width, int height, Apfloat[] rotation_center, Apfloat[] rotation_vals, Fractal fractal, JitterSettings js) {

        super(xCenter, yCenter, size, height_ratio, width, height, rotation_center, rotation_vals, fractal, js);

    }

    public CartesianLocationDeltaBigIntNum(CartesianLocationDeltaBigIntNum other) {
