...
public class PolarLocationDeltaMpirBigNum extends PolarLocationDeltaGenericMpirBigNum {

    public PolarLocationDeltaMpirBigNum(Apfloat xCenter, Apfloat yCenter, Apfloat size, double height_ratio, int width, int height, double circle_period, Apfloat[] rotation_center, Apfloat[] rotation_vals, Fractal fractal, JitterSettings js) {

        super(xCenter, yCenter, size, height_ratio, width, height, circle_period, rotation_center, rotation_vals, fractal, js);

    }

    public PolarLocationDeltaMpirBigNum(PolarLocationDeltaMpirBigNum other) {
