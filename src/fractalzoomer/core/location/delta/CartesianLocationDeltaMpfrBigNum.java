...
public class CartesianLocationDeltaMpfrBigNum extends CartesianLocationDeltaGenericMpfrBigNum {
    public CartesianLocationDeltaMpfrBigNum(Apfloat xCenter, Apfloat yCenter, Apfloat size, double height_ratio, int width, int height, Apfloat[] rotation_center, Apfloat[] rotation_vals, Fractal fractal, JitterSettings js) {
