...
public class ATInfo {
    ...
    public MantExp RefCNormSquared;
    public MantExp CCoeffNormSquaredTFactor;

    protected boolean Usable(MantExp SqrRadius) {
       return SqrEscapeRadius > ESCAPE_RADIUS && CCoeffNormSquaredTFactor.multiply(SqrRadius)
                .compareToBothPositive(RefCNormSquared) > 0;
    }
