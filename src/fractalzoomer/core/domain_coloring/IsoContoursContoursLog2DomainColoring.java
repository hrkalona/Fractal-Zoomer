...
public class IsoContoursContoursLog2DomainColoring extends DomainColoring {
    ...
    public IsoContoursContoursLog2DomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
