...
public class IsoContoursContoursLog2DomainColoring extends DomainColoring {
    ...
    public IsoContoursContoursLog2DomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
