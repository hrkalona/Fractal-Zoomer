...
public class BlackGridIsoContoursDomainColoring extends DomainColoring {
    ...
    public BlackGridIsoContoursDomainColoring(boolean use_palette_domain_coloring, Palette palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
