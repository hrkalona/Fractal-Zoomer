...
public class BrightContoursLog2DomainColoring extends DomainColoring {
    ...
    public BrightContoursLog2DomainColoring(boolean use_palette_domain_coloring, Palette palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
