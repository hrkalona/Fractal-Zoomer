...
public class NormWhiteCirclesLog2DomainColoring extends DomainColoring {
    ...
    public NormWhiteCirclesLog2DomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
