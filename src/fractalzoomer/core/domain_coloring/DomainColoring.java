...
public abstract class DomainColoring {
    ...
    public DomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, int color_interpolation, Blending blending) {
