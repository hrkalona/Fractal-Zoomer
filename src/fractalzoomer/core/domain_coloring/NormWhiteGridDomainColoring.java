...
public class NormWhiteGridDomainColoring extends DomainColoring {
    ...
    public NormWhiteGridDomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
