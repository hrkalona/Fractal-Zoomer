...
public class NormBlackGridContoursLog2IsoLinesDomainColoring extends DomainColoring {
    ...
    public NormBlackGridContoursLog2IsoLinesDomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending, int interpolation, double countourFactor) {
