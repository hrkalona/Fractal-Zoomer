...
public class NormBlackGridContoursLog2IsoLinesDomainColoring extends DomainColoring {
    ...
    public NormBlackGridContoursLog2IsoLinesDomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
