...
public class NormWhiteGridDarkContoursLog2DomainColoring extends DomainColoring {
    ...
    public NormWhiteGridDarkContoursLog2DomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
