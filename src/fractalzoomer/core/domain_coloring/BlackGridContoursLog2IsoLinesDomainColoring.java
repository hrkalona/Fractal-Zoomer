...
public class BlackGridContoursLog2IsoLinesDomainColoring extends DomainColoring {
    ...
    public BlackGridContoursLog2IsoLinesDomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending, int interpolation) {
