...
public class BlackGridContoursLog2IsoLinesDomainColoring extends DomainColoring {
    ...
    public BlackGridContoursLog2IsoLinesDomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
