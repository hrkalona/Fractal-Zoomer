...
public class WhiteGridDomainColoring extends DomainColoring {
    ...
    public WhiteGridDomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
