...
public class NormBlackGridDomainColoring extends DomainColoring {
    ...
    public NormBlackGridDomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending, int interpolation, double countourFactor) {
