...
public class NormBlackGridDomainColoring extends DomainColoring {
    ...
    public NormBlackGridDomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
