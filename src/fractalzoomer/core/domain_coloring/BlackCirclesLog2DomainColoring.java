...
public class BlackCirclesLog2DomainColoring extends DomainColoring {
    ...
    public BlackCirclesLog2DomainColoring(boolean use_palette_domain_coloring, Palette palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
