...
public class NormBlackGridIsoContoursDomainColoring extends DomainColoring {
    ...
    public NormBlackGridIsoContoursDomainColoring(boolean use_palette_domain_coloring, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending) {
