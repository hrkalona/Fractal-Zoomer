...
public class BlackGridWhiteCirclesLog2DomainColoring extends DomainColoring {
    ...
    public BlackGridWhiteCirclesLog2DomainColoring(int domain_coloring_mode, PaletteColor palette, TransferFunction color_transfer, int color_cycling_location, Blending blending, int interpolation, double countourFactor) {
