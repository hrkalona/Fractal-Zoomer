 ...
 * @author hrkalona2
 */
public class ThirdPolynomialInterpolation extends InterpolationMethod {

    public ThirdPolynomialInterpolation() {
        super();
    }
    ...
    public static double getCoefficient(double coef) {
        double temp = coef * coef;
        return 3 * temp - 2 * temp * coef;
    }
