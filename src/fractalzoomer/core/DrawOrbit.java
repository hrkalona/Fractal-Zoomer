...
public class DrawOrbit extends Thread {
    ...
    public DrawOrbit(Settings s, int pixel_x, int pixel_y, int image_size, MainWindow ptr, Color orbit_color, int orbit_style, boolean show_converging_point) {
        ...
        if(!s.julia) {
            InitOrbitSettings(s.xCenter, s.yCenter, s.size, s.max_iterations > 400 ? 400 : s.max_iterations, pixel_x, pixel_y, image_size, ptr, orbit_color, orbit_style, s.plane_type, s.burning_ship, s.mandel_grass, s.mandel_grass_vals, s.function, s.z_exponent, s.z_exponent_complex, s.rotation_vals, s.rotation_center, s.perturbation, s.perturbation_vals, s.variable_perturbation, s.user_perturbation_algorithm, s.user_perturbation_conditions, s.user_perturbation_condition_formula, s.perturbation_user_formula, s.init_val, s.initial_vals, s.variable_init_value, s.user_initial_value_algorithm, s.user_initial_value_conditions, s.user_initial_value_condition_formula, s.initial_value_user_formula, s.coefficients, s.z_exponent_nova, s.relaxation, s.nova_method, s.user_formula, s.user_formula2, s.bail_technique, s.user_plane, s.user_plane_algorithm, s.user_plane_conditions, s.user_plane_condition_formula, s.user_formula_iteration_based, s.user_formula_conditions, s.user_formula_condition_formula, s.height_ratio, s.plane_transform_center, s.plane_transform_angle, s.plane_transform_radius, s.plane_transform_scales, s.plane_transform_wavelength, s.waveType, s.plane_transform_angle2, s.plane_transform_sides, s.plane_transform_amount, s.polar_projection, s.circle_period, s.user_fz_formula, s.user_dfz_formula, s.user_ddfz_formula, show_converging_point, s.coupling, s.user_formula_coupled, s.coupling_method, s.coupling_amplitude, s.coupling_frequency, s.coupling_seed, s.laguerre_deg);
        }
        else {
            InitOrbitSettings(s.xCenter, s.yCenter, s.size, s.max_iterations > 400 ? 400 : s.max_iterations, pixel_x, pixel_y, image_size, ptr, orbit_color, orbit_style, s.plane_type, s.apply_plane_on_julia, s.apply_plane_on_julia_seed, s.burning_ship, s.mandel_grass, s.mandel_grass_vals, s.function, s.z_exponent, s.z_exponent_complex, s.rotation_vals, s.rotation_center, s.coefficients, s.z_exponent_nova, s.relaxation, s.nova_method, s.user_formula, s.user_formula2, s.bail_technique, s.user_plane, s.user_plane_algorithm, s.user_plane_conditions, s.user_plane_condition_formula, s.user_formula_iteration_based, s.user_formula_conditions, s.user_formula_condition_formula, s.height_ratio, s.plane_transform_center, s.plane_transform_angle, s.plane_transform_radius, s.plane_transform_scales, s.plane_transform_wavelength, s.waveType, s.plane_transform_angle2, s.plane_transform_sides, s.plane_transform_amount, s.polar_projection, s.circle_period, show_converging_point, s.coupling, s.user_formula_coupled, s.coupling_method, s.coupling_amplitude, s.coupling_frequency, s.coupling_seed, s.xJuliaCenter, s.yJuliaCenter);
        }
    ...
    public DrawOrbit(Settings s, double pixel_x, double pixel_y, int sec_points, int image_size, MainWindow ptr, Color orbit_color, int orbit_style, boolean show_converging_point) {
        ...
        if(!s.julia) {
            InitOrbitSettings(s.xCenter, s.yCenter, s.size, sec_points, pixel_x, pixel_y, image_size, ptr, orbit_color, orbit_style, s.plane_type, s.burning_ship, s.mandel_grass, s.mandel_grass_vals, s.function, s.z_exponent, s.z_exponent_complex, s.rotation_vals, s.rotation_center, s.perturbation, s.perturbation_vals, s.variable_perturbation, s.user_perturbation_algorithm, s.user_perturbation_conditions, s.user_perturbation_condition_formula, s.perturbation_user_formula, s.init_val, s.initial_vals, s.variable_init_value, s.user_initial_value_algorithm, s.user_initial_value_conditions, s.user_initial_value_condition_formula, s.initial_value_user_formula, s.coefficients, s.z_exponent_nova, s.relaxation, s.nova_method, s.user_formula, s.user_formula2, s.bail_technique, s.user_plane, s.user_plane_algorithm, s.user_plane_conditions, s.user_plane_condition_formula, s.user_formula_iteration_based, s.user_formula_conditions, s.user_formula_condition_formula, s.height_ratio, s.plane_transform_center, s.plane_transform_angle, s.plane_transform_radius, s.plane_transform_scales, s.plane_transform_wavelength, s.waveType, s.plane_transform_angle2, s.plane_transform_sides, s.plane_transform_amount, s.polar_projection, s.circle_period, s.user_fz_formula, s.user_dfz_formula, s.user_ddfz_formula, show_converging_point, s.coupling, s.user_formula_coupled, s.coupling_method, s.coupling_amplitude, s.coupling_frequency, s.coupling_seed, s.laguerre_deg);
        }
        else {
            InitOrbitSettings(s.xCenter, s.yCenter, s.size, sec_points, pixel_x, pixel_y, image_size, ptr, orbit_color, orbit_style, s.plane_type, s.apply_plane_on_julia, s.apply_plane_on_julia_seed, s.burning_ship, s.mandel_grass, s.mandel_grass_vals, s.function, s.z_exponent, s.z_exponent_complex, s.rotation_vals, s.rotation_center, s.coefficients, s.z_exponent_nova, s.relaxation, s.nova_method, s.user_formula, s.user_formula2, s.bail_technique, s.user_plane, s.user_plane_algorithm, s.user_plane_conditions, s.user_plane_condition_formula, s.user_formula_iteration_based, s.user_formula_conditions, s.user_formula_condition_formula, s.height_ratio, s.plane_transform_center, s.plane_transform_angle, s.plane_transform_radius, s.plane_transform_scales, s.plane_transform_wavelength, s.waveType, s.plane_transform_angle2, s.plane_transform_sides, s.plane_transform_amount, s.polar_projection, s.circle_period, show_converging_point, s.coupling, s.user_formula_coupled, s.coupling_method, s.coupling_amplitude, s.coupling_frequency, s.coupling_seed, s.xJuliaCenter, s.yJuliaCenter);
        }
