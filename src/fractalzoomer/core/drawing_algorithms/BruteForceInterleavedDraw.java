...
public class BruteForceInterleavedDraw extends TaskDraw {
    ...
    public BruteForceInterleavedDraw(int FROMx, int TOx, int FROMy, int TOy, D3Settings d3s, boolean draw_action, MainWindow ptr, BufferedImage image, FiltersSettings fs, BlendingSettings color_blending, double contourFactor, boolean smoothing, GeneratedPaletteSettings gps) {
    ...
    private void drawIterationsInternal(int condition, int thread_chunk_size, int image_size, int pixel_percent, AtomicInteger dCount, Location location, int a, int b) {
        int x, y, loc;
        double f_val;
        boolean escaped_val;
        do {
    ...
    protected void drawIterations(int image_size, boolean polar) throws StopSuccessiveRefinementException {
        ...
        drawIterationsInternal(condition, thread_chunk_size, image_size, pixel_percent, normal_drawing_algorithm_pixel, location, 2, 0);
        drawIterationsInternal(condition, thread_chunk_size, image_size, pixel_percent, normal_drawing_algorithm_pixel2, location, 2, 1);
        pixel_calculation_time_per_task = System.currentTimeMillis() - time;

        postProcess(image_size, null, location);
    }

    private void drawIterationsAntialiasedInternal(int condition, int thread_chunk_size, int image_size, int pixel_percent, boolean storeExtraData, AntialiasingAlgorithm aa, int supersampling_num, int totalSamples, AtomicInteger dCount, Location location, int a, int b) {
        int x, y, loc;
    ...
    protected void drawIterationsAntialiased(int image_size, boolean polar) throws StopSuccessiveRefinementException {
        ...
        long time = System.currentTimeMillis();
        drawIterationsAntialiasedInternal(condition, thread_chunk_size, image_size, pixel_percent, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel, location, 2, 0);
        drawIterationsAntialiasedInternal(condition, thread_chunk_size, image_size, pixel_percent, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel2, location, 2, 1);
        pixel_calculation_time_per_task = System.currentTimeMillis() - time;

        postProcess(image_size, aa, location);
    }

    private void drawFastJuliaInternal(int condition, int thread_chunk_size, int image_size, AtomicInteger dCount, Location location, int a, int b) {
        boolean escaped_val;
        double f_val;
        int loc, x, y;
    ...
    protected void drawFastJulia(int image_size, boolean polar) {
        ...
        drawFastJuliaInternal(condition, thread_chunk_size, image_size, normal_drawing_algorithm_pixel, location, 2, 0);
        drawFastJuliaInternal(condition, thread_chunk_size, image_size, normal_drawing_algorithm_pixel2, location, 2, 1);

        postProcessFastJulia(image_size, null, location);

    }

    private void drawFastJuliaAntialiasedInternal(int condition, int thread_chunk_size, int image_size, boolean storeExtraData, AntialiasingAlgorithm aa, int supersampling_num, int totalSamples, AtomicInteger dCount, Location location, int a, int b) {
        int loc, x, y, color;
        double f_val, temp_result;
        boolean escaped_val;
        do {
    ...
    protected void drawFastJuliaAntialiased(int image_size, boolean polar) {
        ...
        drawFastJuliaAntialiasedInternal(condition, thread_chunk_size, image_size, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel, location, 2, 0);
        drawFastJuliaAntialiasedInternal(condition, thread_chunk_size, image_size, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel2, location, 2, 1);

        postProcessFastJulia(image_size, aa, location);
    }

    private void applyPostProcessingPointFilterInternal(double[] image_iterations, boolean[] escaped, PixelExtraData[] pixelData, int condition, int thread_chunk_size, int image_size, AtomicInteger dCount, Location location, double sizeCorr, double lightx, double lighty, AntialiasingAlgorithm aa, int[] modified, int a, int b) {
        int loc, x, y;
        do {
    ...
    protected void applyPostProcessingPointFilter(int image_size, double[] image_iterations, boolean[] escaped, PixelExtraData[] pixelData, AntialiasingAlgorithm aa, Location location) {
        ...
        applyPostProcessingPointFilterInternal(image_iterations, escaped, pixelData, condition, thread_chunk_size, image_size, normal_drawing_algorithm_post_processing, location, sizeCorr, lightx, lighty, aa, modified, 2, 0);
        applyPostProcessingPointFilterInternal(image_iterations, escaped, pixelData, condition, thread_chunk_size, image_size, normal_drawing_algorithm_post_processing2, location, sizeCorr, lightx, lighty, aa, modified, 2, 1);
    ...
    protected void changePaletteWithAA(int image_size) throws StopSuccessiveRefinementException {
        ...
        changePaletteWithAAInternal(condition, thread_chunk_size, pixel_percent, aa, normal_drawing_algorithm_apply_palette, 2, 0);
        changePaletteWithAAInternal(condition, thread_chunk_size, pixel_percent, aa, normal_drawing_algorithm_apply_palette2, 2, 1);
    ...
    protected void changePalette(int image_size) throws StopSuccessiveRefinementException {
        ...
        changePaletteInternal(condition, thread_chunk_size, pixel_percent, normal_drawing_algorithm_apply_palette, 2, 0);
        changePaletteInternal(condition, thread_chunk_size, pixel_percent, normal_drawing_algorithm_apply_palette2, 2, 1);
    ...
    private void drawIterationsDomainInternal(int condition, int thread_chunk_size, int image_size, int pixel_percent, AtomicInteger dCount, Location location, int a, int b) {
        int loc, x, y;
        do {
    ...
    protected void drawIterationsDomain(int image_size, boolean polar) {
        ...
        drawIterationsDomainInternal(condition, thread_chunk_size, image_size, pixel_percent, normal_drawing_algorithm_pixel, location, 2, 0);
        drawIterationsDomainInternal(condition, thread_chunk_size, image_size, pixel_percent, normal_drawing_algorithm_pixel2, location, 2, 1);
    ...
    private void drawIterationsDomainAntialiasedInternal(int condition, int thread_chunk_size, int image_size, int pixel_percent, boolean storeExtraData, AntialiasingAlgorithm aa, int supersampling_num, int totalSamples, AtomicInteger dCount, Location location, int a, int b) {
        int loc, x, y, color;
        double f_val;
        do {
    ...
    protected void drawIterationsDomainAntialiased(int image_size, boolean polar) {
        ...
        drawIterationsDomainAntialiasedInternal(condition, thread_chunk_size, image_size, pixel_percent, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel, location, 2, 0);
        drawIterationsDomainAntialiasedInternal(condition, thread_chunk_size, image_size, pixel_percent, storeExtraData, aa, supersampling_num, totalSamples, normal_drawing_algorithm_pixel2, location, 2, 1);
