...
public abstract class ThreadDraw extends Thread {
    ...
    public ThreadDraw(int FROMx, int TOx, int FROMy, int TOy, double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, String bailout_test_user_formula, String bailout_test_user_formula2, int bailout_test_comparison, double n_norm, D3Settings d3s, MainWindow ptr, Color fractal_color, Color dem_color, BufferedImage image, boolean[] filters, int[] filters_options_vals, int[][] filters_options_extra_vals, int out_coloring_algorithm, int user_out_coloring_algorithm, String outcoloring_formula, String[] user_outcoloring_conditions, String[] user_outcoloring_condition_formula, int in_coloring_algorithm, int user_in_coloring_algorithm, String incoloring_formula, String[] user_incoloring_conditions, String[] user_incoloring_condition_formula, boolean smoothing, boolean periodicity_checking, int plane_type, boolean burning_ship, boolean mandel_grass, double[] mandel_grass_vals, int function, double z_exponent, double[] z_exponent_complex, int color_cycling_location, double[] rotation_vals, double[] rotation_center, boolean perturbation, double[] perturbation_vals, boolean variable_perturbation, int user_perturbation_algorithm, String[] user_perturbation_conditions, String[] user_perturbation_condition_formula, String perturbation_user_formula, boolean init_val, double[] initial_vals, boolean variable_init_value, int user_initial_value_algorithm, String[] user_initial_value_conditions, String[] user_initial_value_condition_formula, String initial_value_user_formula, double[] coefficients, double[] z_exponent_nova, double[] relaxation, int nova_method, String user_formula, String user_formula2, int bail_technique, String user_plane, int user_plane_algorithm, String[] user_plane_conditions, String[] user_plane_condition_formula, String[] user_formula_iteration_based, String[] user_formula_conditions, String[] user_formula_condition_formula, boolean exterior_de, double exterior_de_factor, double height_ratio, double[] plane_transform_center, double plane_transform_angle, double plane_transform_radius, double[] plane_transform_scales, double[] plane_transform_wavelength, int waveType, double plane_transform_angle2, int plane_transform_sides, double plane_transform_amount, int escaping_smooth_algorithm, int converging_smooth_algorithm, BumpMapSettings bms, boolean polar_projection, double circle_period, FakeDistanceEstimationSettings fdes, RainbowPaletteSettings rps, String user_fz_formula, String user_dfz_formula, String user_ddfz_formula, Color[] filters_colors, Color[][] filters_extra_colors, int[] filters_order, double coupling, String[] user_formula_coupled, int coupling_method, double coupling_amplitude, double coupling_frequency, int coupling_seed, DomainColoringSettings ds, boolean inverse_dem, boolean quickDraw, boolean custom_palette_choice, int[][] custom_palette, int color_interpolation, int color_space, boolean reverse, double scale_factor_palette_val, int processing_alg, double color_intensity, int transfer_function, Color special_color, int color_smoothing_method, int color_choice, EntropyColoringSettings ens, OffsetColoringSettings ofs, GreyscaleColoringSettings gss, double[] laguerre_deg, int color_blending) {
        ...
        if (custom_palette_choice) {
            palette = new CustomPalette(custom_palette, color_interpolation, color_space, reverse, scale_factor_palette_val, processing_alg, smoothing, special_color, color_smoothing_method);
        } else {
            palette = new PresetPalette(color_choice, smoothing, special_color, color_smoothing_method);
        }
        ...
        switch (function) {
            ...
            case MainWindow.LAGUERREFORMULA:
                fractal = new LaguerreFormula(xCenter, yCenter, size, max_iterations, out_coloring_algorithm, user_out_coloring_algorithm, outcoloring_formula, user_outcoloring_conditions, user_outcoloring_condition_formula, in_coloring_algorithm, user_in_coloring_algorithm, incoloring_formula, user_incoloring_conditions, user_incoloring_condition_formula, smoothing, plane_type, rotation_vals, rotation_center, user_plane, user_plane_algorithm, user_plane_conditions, user_plane_condition_formula, plane_transform_center, plane_transform_angle, plane_transform_radius, plane_transform_scales, plane_transform_wavelength, waveType, plane_transform_angle2, plane_transform_sides, plane_transform_amount, converging_smooth_algorithm, user_fz_formula, user_dfz_formula, user_ddfz_formula, laguerre_deg);
                break;
    ...
    //Color Cycling
    public ThreadDraw(int FROMx, int TOx, int FROMy, int TOy, int max_iterations, MainWindow ptr, Color fractal_color, Color dem_color, BufferedImage image, int color_cycling_location, BumpMapSettings bms, FakeDistanceEstimationSettings fdes, RainbowPaletteSettings rps, int color_cycling_speed, boolean[] filters, int[] filters_options_vals, int[][] filters_options_extra_vals, Color[] filters_colors, Color[][] filters_extra_colors, int[] filters_order, boolean custom_palette_choice, int[][] custom_palette, int color_interpolation, int color_space, boolean reverse, double scale_factor_palette_val, int processing_alg, double color_intensity, int transfer_function, Color special_color, int color_smoothing_method, int color_choice, boolean smoothing, EntropyColoringSettings ens, OffsetColoringSettings ofs, GreyscaleColoringSettings gss, int color_blending) {
    ...
    //Apply Filter
    public ThreadDraw(int FROMx, int TOx, int FROMy, int TOy, int max_iterations, MainWindow ptr, BufferedImage image, Color fractal_color, Color dem_color, int color_cycling_location, boolean[] filters, int[] filters_options_vals, int[][] filters_options_extra_vals, BumpMapSettings bms, FakeDistanceEstimationSettings fdes, RainbowPaletteSettings rps, Color[] filters_colors, Color[][] filters_extra_colors, int[] filters_order, boolean custom_palette_choice, int[][] custom_palette, int color_interpolation, int color_space, boolean reverse, double scale_factor_palette_val, int processing_alg, double color_intensity, int transfer_function, Color special_color, int color_smoothing_method, int color_choice, boolean smoothing, EntropyColoringSettings ens, OffsetColoringSettings ofs, GreyscaleColoringSettings gss, int color_blending) {
    ...
    //Rotate 3d model
    public ThreadDraw(int FROMx, int TOx, int FROMy, int TOy, D3Settings d3s, boolean draw_action, MainWindow ptr, BufferedImage image, boolean[] filters, int[] filters_options_vals, int[][] filters_options_extra_vals, Color[] filters_colors, Color[][] filters_extra_colors, int[] filters_order, int color_blending) {
    ...
    private int offsetColoring(double[] image_iterations, int i, int j, int image_size, int color) {
        ...
        int color2 = getColor(res + post_process_offset);
    ...
    private int entropyColoring(double[] image_iterations, int i, int j, int image_size, int color) {
        ...
        for (int k = i - kernel_size2, p = 0; p < kernel_size; k++, p++) {
            for (int l = j - kernel_size2, t = 0; t < kernel_size; l++, t++) {
                ...
                if (k >= 0 && k < image_size && l >= 0 && l < image_size) {
                    ...
                    double temp = ColorAlgorithm.getResultWithoutIncrement(image_iterations[k * image_size + l]);
        ...
        int color2 = getColor(entropy_offset + res + entropy_palette_factor * Math.abs(sum2));
    ...
    private int paletteRainbow(double[] image_iterations, int i, int j, int image_size, int color) {
        ...
        double n0 = ColorAlgorithm.getResultWithoutIncrement(image_iterations[k0]);
        ...
        if (i < image_size - 1) {
            double nx = ColorAlgorithm.getResultWithoutIncrement(image_iterations[kx]);
            zx = sx * (nx - n0);
        }

        if (j < image_size - 1) {
            double ny = ColorAlgorithm.getResultWithoutIncrement(image_iterations[ky]);
            zy = sy * (ny - n0);
        }

        if (i > 0) {
            double nx2 = ColorAlgorithm.getResultWithoutIncrement(image_iterations[kx2]);
            zx2 = sx2 * (nx2 - n0);
        }

        if (j > 0) {
            double ny2 = ColorAlgorithm.getResultWithoutIncrement(image_iterations[ky2]);
            zy2 = sy2 * (ny2 - n0);
        }
            ...
            for (int x = FROMx; x < TOx; x++) {
                ...
                if (bump_map) {
                    ...
                    if (this.bumpProcessing == 0) {
                        ...
                        if (dotp != 0 || (dotp == 0 && !isInt(image_iterations[index]))) {
                            gradAbs = Math.sqrt(gradx * gradx + grady * grady);
                            cosAngle = dotp / gradAbs;
                            smoothGrad = -2.3562 / (gradAbs * sizeCorr + 1.5) + 1.57;
                            //smoothGrad = Math.atan(gradAbs * sizeCorr);
    ...
    private double getGradientX(double[] image_iterations, int index, int size) {
        ...
        int x = index % size;
        double it = ColorAlgorithm.getResultWithoutIncrement(image_iterations[index]);

        if (x == 0) {
            return (ColorAlgorithm.getResultWithoutIncrement(image_iterations[index + 1]) - it) * 2;
        } else if (x == size - 1) {
            return (it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index - 1])) * 2;
        } else {
            double diffL = it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index - 1]);
            double diffR = it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index + 1]);
    ...
    private double getGradientY(double[] image_iterations, int index, int size) {
        ...
        if (y == 0) {
            return (it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index + size])) * 2;
        } else if (y == size - 1) {
            return (ColorAlgorithm.getResultWithoutIncrement(image_iterations[index - size]) - it) * 2;
        } else {
            double diffU = it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index - size]);
            double diffD = it - ColorAlgorithm.getResultWithoutIncrement(image_iterations[index + size]);
    ...
    private int changeBrightnessOfColorBlending(int rgb, double delta) {
        int new_color = 0;
        ...
        int red = (new_color >> 16) & 0xFF;
        int green = (new_color >> 8) & 0xFF;
        int blue = new_color & 0xFF;

        int old_red = (old_rgb >> 16) & 0xFF;
        int old_green = (old_rgb >> 8) & 0xFF;
        int old_blue = old_rgb & 0xFF;

        return blending.blend(red, green, blue, old_red, old_green, old_blue, 1 - bump_blending);
        ...
        for (int i = ib; i != ie; i += sti) {
            for (int j = jb; j != je; j += stj) {
                ...
                if (Norm1z[i][j][0] > 0) {
                    ...
                    int shade = (int) (Norm1z[i][j][0] + 0.5);
                    g.setColor(new Color(blending.blend(shade, shade, shade, red, green, blue, color_3d_blending)));
                ...
                if (Norm1z[i][j][1] > 0) {
                    ...
                    int shade = (int) (Norm1z[i][j][1] + 0.5);
                    g.setColor(new Color(blending.blend(shade, shade, shade, red, green, blue, color_3d_blending)));
    ...
    private void domainColoringFactory(DomainColoringSettings ds) {
        ...
        if(ds.customDomainColoring) {
            domain_color = new CustomDomainColoring(ds, palette, color_transfer, color_cycling_location, blending);
            return;
        }
