...
public class ClosestToMidPointAntialiasingAlgorithmRGB extends AntialiasingAlgorithm {
    ...
    public ClosestToMidPointAntialiasingAlgorithmRGB(int totalSamples, boolean avgWithMean) {
        super(totalSamples);
        redSum = 0;
        greenSum = 0;
        blueSum = 0;
