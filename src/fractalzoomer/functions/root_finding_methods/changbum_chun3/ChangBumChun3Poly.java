...
public class ChangBumChun3Poly extends ChangBumChun3RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex temp = getFunctionAndDerivativeArgument(complex[0], fz, dfz);
        Complex ffz;
        ...
        changbumChun3Method(complex[0], fz, dfz, ffz, combined_dfz);
