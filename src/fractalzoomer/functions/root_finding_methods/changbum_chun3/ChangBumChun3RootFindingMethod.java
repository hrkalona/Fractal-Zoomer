...
public abstract class ChangBumChun3RootFindingMethod extends RootFindingMethods {
    ...
    public Complex changbumChun3Method(Complex z, Complex fz, Complex dfz, Complex ffz, Complex df_combined) {
       ...
       z.sub_mutable(fz.divide(dfz)).sub_mutable(ffz.times2().divide_mutable(dfz)).plus_mutable(ffz.times(df_combined).divide_mutable(dfz.square()));
       return z;
    ...
    public static Complex changbumChun3Method(Complex z, Complex fz, Complex dfz, Complex ffz, Complex df_combined, Complex relaxation) {
        ...
        z.sub_mutable(fz.divide(dfz).times_mutable(relaxation)).sub_mutable(ffz.times2().divide_mutable(dfz).times_mutable(relaxation)).plus_mutable(ffz.times(df_combined).divide_mutable(dfz.square()).times_mutable(relaxation));
        return z;
    ...
    public static Complex changbumChun3Step(Complex fz, Complex dfz, Complex ffz, Complex df_combined) {
        ...
        return fz.divide(dfz).plus_mutable(ffz.times2().divide_mutable(dfz)).sub_mutable(ffz.times(df_combined).divide_mutable(dfz.square()));
