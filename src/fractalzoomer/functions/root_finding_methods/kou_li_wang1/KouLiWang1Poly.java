...
public class KouLiWang1Poly extends KouLiWang1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        kouLiWang1Method(complex[0], fz, dfz, ffz);
