...
public class ContraHarmonicNewton3 extends ContraHarmonicNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex combined_dfz = temp.square().times_mutable(3);
