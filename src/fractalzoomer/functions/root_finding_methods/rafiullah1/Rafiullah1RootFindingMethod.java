...
public abstract class Rafiullah1RootFindingMethod extends RootFindingMethods {
    ...
    public Complex rafiullah1Method(Complex z, Complex fz, Complex dfz, Complex combined_dfz) {
        ...
        z.sub_mutable(fz.divide(dfz)).sub_mutable(fz.times(dfz).times_mutable(temp).divide_mutable(dfz.cube().plus_mutable(dfz.square().times_mutable(temp)).times_mutable(2)));
        return z;
    ...
    public static Complex rafiullah1Method(Complex z, Complex fz, Complex dfz, Complex combined_dfz, Complex relaxation) {
        ...
        Complex temp = combined_dfz.sub(dfz);
        z.sub_mutable(fz.divide(dfz).times_mutable(relaxation)).sub_mutable(fz.times(dfz).times_mutable(temp).divide_mutable(dfz.cube().plus_mutable(dfz.square().times_mutable(temp)).times_mutable(2)).times_mutable(relaxation));
        return z;
    ...
    public static Complex rafiullah1Step(Complex fz, Complex dfz, Complex combined_dfz) {
        ...
        Complex temp = combined_dfz.sub(dfz);
        return fz.divide(dfz).plus_mutable(fz.times(dfz).times_mutable(temp).divide_mutable(dfz.cube().plus_mutable(dfz.square().times_mutable(temp)).times_mutable(2)));
