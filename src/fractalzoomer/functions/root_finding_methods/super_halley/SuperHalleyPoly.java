...
public class SuperHalleyPoly extends SuperHalleyRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        superHalleyMethod(complex[0], fz, dfz, ddfz);
