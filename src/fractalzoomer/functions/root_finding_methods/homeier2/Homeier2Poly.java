...
public class Homeier2Poly extends Homeier2RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        homeier2Method(complex[0], fz, dfz, combined_dfz);
