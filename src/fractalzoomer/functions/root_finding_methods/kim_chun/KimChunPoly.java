package fractalzoomer.functions.root_finding_methods.kim_chun;
...
public class KimChunPoly extends KimChunRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        kimChunMethod(complex[0], fz, dfz, combined_dfz);
