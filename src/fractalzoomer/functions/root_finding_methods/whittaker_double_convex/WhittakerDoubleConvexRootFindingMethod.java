...
public abstract class WhittakerDoubleConvexRootFindingMethod extends RootFindingMethods {
    ...
    public Complex whittakerDoubleConvexMethod(Complex z, Complex fz, Complex dfz, Complex ddfz) {
        ...
        Complex fraction = (lfz.times2().plus_mutable(4)).divide_mutable(lfz.times(lfz.r_sub(2)).r_sub_mutable(2));
