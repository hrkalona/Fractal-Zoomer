...
public class EulerChebyshevPoly extends EulerChebyshevRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        eulerChebyshevMethod(complex[0], fz, dfz, ddfz);
