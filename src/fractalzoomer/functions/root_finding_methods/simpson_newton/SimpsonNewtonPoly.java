...
public class SimpsonNewtonPoly extends SimpsonNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(usesComplexCoefficients) {
            ...
            dfz = complex[0].ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(complex[0].eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(complex[0].seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(complex[0].sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(complex[0].fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(complex[0].fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(complex[0].cube().times_mutable(complex_coefficients[6].times(4))).plus_mutable(complex[0].square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(complex[0].times(complex_coefficients[8].times(2))).plus_mutable(complex_coefficients[9]);
        }
        else {
        ...
        Complex temp = getDerivativeArgument(complex[0], fz, dfz);

        Complex combined_dfz, combined_dfz2;

        if(usesComplexCoefficients) {
            combined_dfz = temp.ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(temp.eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(temp.seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(temp.sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(temp.fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(temp.fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(temp.cube().times_mutable(complex_coefficients[6].times(4))).plus_mutable(temp.square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(temp.times(complex_coefficients[8].times(2))).plus_mutable(complex_coefficients[9]);
        }
        else {
            combined_dfz = temp.ninth().times_mutable(10 * coefficients[0]).plus_mutable(temp.eighth().times_mutable(9 * coefficients[1])).plus_mutable(temp.seventh().times_mutable(8 * coefficients[2])).plus_mutable(temp.sixth().times_mutable(7 * coefficients[3])).plus_mutable(temp.fifth().times_mutable(6 * coefficients[4])).plus_mutable(temp.fourth().times_mutable(5 * coefficients[5])).plus_mutable(temp.cube().times_mutable(4 * coefficients[6])).plus_mutable(temp.square().times_mutable(3 * coefficients[7])).plus_mutable(temp.times(2 * coefficients[8])).plus_mutable(coefficients[9]);
        }

        Complex temp2 = complex[0].plus(temp).times_mutable(0.5);

        if(usesComplexCoefficients) {
            combined_dfz2 = temp2.ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(temp2.eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(temp2.seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(temp2.sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(temp2.fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(temp2.fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(temp2.cube().times_mutable(complex_coefficients[6].times(4))).plus_mutable(temp2.square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(temp2.times(complex_coefficients[8].times(2))).plus_mutable(complex_coefficients[9]);
        }
        else {
            combined_dfz2 = temp2.ninth().times_mutable(10 * coefficients[0]).plus_mutable(temp2.eighth().times_mutable(9 * coefficients[1])).plus_mutable(temp2.seventh().times_mutable(8 * coefficients[2])).plus_mutable(temp2.sixth().times_mutable(7 * coefficients[3])).plus_mutable(temp2.fifth().times_mutable(6 * coefficients[4])).plus_mutable(temp2.fourth().times_mutable(5 * coefficients[5])).plus_mutable(temp2.cube().times_mutable(4 * coefficients[6])).plus_mutable(temp2.square().times_mutable(3 * coefficients[7])).plus_mutable(temp2.times(2 * coefficients[8])).plus_mutable(coefficients[9]);
        }
