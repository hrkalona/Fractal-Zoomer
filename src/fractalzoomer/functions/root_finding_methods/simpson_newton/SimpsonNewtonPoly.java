...
public class SimpsonNewtonPoly extends SimpsonNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(usesComplexCoefficients) {
            combined_dfz = temp.ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(temp.eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(temp.seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(temp.sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(temp.fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(temp.fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(temp.cube().times_mutable(complex_coefficients[6].times4())).plus_mutable(temp.square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(temp.times(complex_coefficients[8].times2())).plus_mutable(complex_coefficients[9]);
        }
        else {
        ...
        if(usesComplexCoefficients) {
            combined_dfz2 = temp2.ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(temp2.eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(temp2.seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(temp2.sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(temp2.fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(temp2.fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(temp2.cube().times_mutable(complex_coefficients[6].times4())).plus_mutable(temp2.square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(temp2.times(complex_coefficients[8].times2())).plus_mutable(complex_coefficients[9]);
        }
        else {
