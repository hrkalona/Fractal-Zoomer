...
public class EzzatiSaleki1Poly extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        ezzatiSaleki1Method(complex[0], fz, dfz, ffz, combined_dfz);
