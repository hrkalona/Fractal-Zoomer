...
public class EzzatiSaleki1Formula extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(Derivative.DERIVATIVE_METHOD == Derivative.DISABLED) {
            ...
            combined_dfz = Derivative.numericalForwardDerivativeFirstOrder(comb_fz, fzdz);
            ...
            combined_dfz = Derivative.numericalBackwardDerivativeFirstOrder(comb_fz, fzmdz);
        }
