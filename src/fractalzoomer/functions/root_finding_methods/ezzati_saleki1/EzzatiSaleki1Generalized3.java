...
public class EzzatiSaleki1Generalized3 extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ffz = temp.cube().sub_mutable(temp.times2()).plus_mutable(2);
