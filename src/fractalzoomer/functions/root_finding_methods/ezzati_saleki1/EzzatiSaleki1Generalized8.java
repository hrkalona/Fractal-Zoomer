...
public class EzzatiSaleki1Generalized8 extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ffz = temp.eighth().plus_mutable(temp.fourth().times_mutable(15)).sub_mutable(16);
