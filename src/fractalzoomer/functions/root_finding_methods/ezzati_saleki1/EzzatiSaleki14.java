...
public class EzzatiSaleki14 extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ffz = temp.fourth().sub_mutable(1);
