...
public class EzzatiSaleki13 extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ffz = temp.cube().sub_mutable(1);
