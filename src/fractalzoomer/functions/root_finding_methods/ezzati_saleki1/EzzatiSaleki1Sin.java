...
public class EzzatiSaleki1Sin extends EzzatiSaleki1RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex temp2 = getFunctionAndDerivativeArgument(complex[0], fz, dfz);
        Complex ffz = temp2.sin();

        Complex combined_dfz = temp2.cos();
