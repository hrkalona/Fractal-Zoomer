...
public class StirlingSin extends StirlingRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex fz = complex[0].sin();

        Complex temp = getDerivativeArgument(complex[0], fz);

        Complex combined_dfz = temp.cos();
