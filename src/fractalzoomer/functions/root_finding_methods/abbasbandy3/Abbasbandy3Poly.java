package fractalzoomer.functions.root_finding_methods.abbasbandy3;
...
public class Abbasbandy3Poly extends Abbasbandy3RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(usesComplexCoefficients) {
            ...
            ddfz = complex[0].eighth().times_mutable(complex_coefficients[0].times(90)).plus_mutable(complex[0].seventh().times_mutable(complex_coefficients[1].times(72))).plus_mutable(complex[0].sixth().times_mutable(complex_coefficients[2].times(56))).plus_mutable(complex[0].fifth().times_mutable(complex_coefficients[3].times(42))).plus_mutable(complex[0].fourth().times_mutable(complex_coefficients[4].times(30))).plus_mutable(complex[0].cube().times_mutable(complex_coefficients[5].times(20))).plus_mutable(complex[0].square().times_mutable(complex_coefficients[6].times(12))).plus_mutable(complex[0].times(complex_coefficients[7].times(6))).plus_mutable(complex_coefficients[8].times(2));
            dddfz = complex[0].seventh().times_mutable(complex_coefficients[0].times(720)).plus_mutable(complex[0].sixth().times_mutable(complex_coefficients[1].times(504))).plus_mutable(complex[0].fifth().times_mutable(complex_coefficients[2].times(336))).plus_mutable(complex[0].fourth().times_mutable(complex_coefficients[3].times(210))).plus_mutable(complex[0].cube().times_mutable(complex_coefficients[4].times(120))).plus_mutable(complex[0].square().times_mutable(complex_coefficients[5].times(60))).plus_mutable(complex[0].times(complex_coefficients[6].times(24))).plus_mutable(complex_coefficients[7].times(6));
        }
        else {
            ...
            dddfz = complex[0].seventh().times_mutable(720 * coefficients[0]).plus_mutable(complex[0].sixth().times_mutable(504 * coefficients[1])).plus_mutable(complex[0].fifth().times_mutable(336 * coefficients[2])).plus_mutable(complex[0].fourth().times_mutable(210 * coefficients[3])).plus_mutable(complex[0].cube().times_mutable(120 * coefficients[4])).plus_mutable(complex[0].square().times_mutable(60 * coefficients[5])).plus_mutable(complex[0].times(24 * coefficients[6])).plus_mutable(6 * coefficients[7]);
        }

        abbasbandy3Method(complex[0], fz, dfz, ddfz, dddfz);
