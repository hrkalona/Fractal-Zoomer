...
public class Abbasbandy3Generalized8 extends Abbasbandy3RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex dddfz = complex[0].fifth().times_mutable(336).plus_mutable(complex[0].times(360));
