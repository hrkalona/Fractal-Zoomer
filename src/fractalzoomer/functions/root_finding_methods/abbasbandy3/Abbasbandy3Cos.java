...
public class Abbasbandy3Cos extends Abbasbandy3RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex[] temp = complex[0].der0123_cos();

        Complex fz = temp[0];
        Complex dfz = temp[1];
        Complex ddfz = temp[2];
        Complex dddfz = temp[3];
