...
public class MullerSin extends MullerRootFindingMethod {
    ...
    public double calculateFractalWithoutPeriodicity(Complex pixel) {
        ...
        complex[3] = complex[1].sin(); //fz-1
        complex[4] = new Complex(0, 0); //fz-2
