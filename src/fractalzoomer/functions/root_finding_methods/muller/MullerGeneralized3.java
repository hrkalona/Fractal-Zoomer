...
public class MullerGeneralized3 extends MullerRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        complex[3] = complex[1].cube().sub_mutable(complex[1].times2()).plus_mutable(2);//fz-1
        complex[4] = new Complex(2, 0); //fz-2
