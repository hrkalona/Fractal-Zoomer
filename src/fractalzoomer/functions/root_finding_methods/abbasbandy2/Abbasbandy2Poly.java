...
public class Abbasbandy2Poly extends Abbasbandy2RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        abbasbandy2Method(complex[0], fz, dfz, ddfz);
