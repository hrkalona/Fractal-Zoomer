...
public abstract class ChangBumChun1RootFindingMethod extends RootFindingMethods {
    ...
    public Complex changbumChun1Method(Complex z, Complex fz, Complex dfz, Complex ffz) {
        ...
        z.sub_mutable(fz.divide(dfz)).sub_mutable(fzSquared.times(ffz).divide_mutable((fzSquared.sub(fz.times(ffz).times2_mutable()).plus_mutable(ffz.square())).times_mutable(dfz)));
    ...
    public static Complex changbumChun1Method(Complex z, Complex fz, Complex dfz, Complex ffz, Complex relaxation) {
        ...
        Complex fzSquared = fz.square();
        z.sub_mutable(fz.divide(dfz).times_mutable(relaxation)).sub_mutable(fzSquared.times(ffz).divide_mutable((fzSquared.sub(fz.times(ffz).times2_mutable()).plus_mutable(ffz.square())).times_mutable(dfz)).times_mutable(relaxation));
    ...
    public static Complex changbumChun1Step(Complex fz, Complex dfz, Complex ffz) {
        ...
        Complex fzSquared = fz.square();
        return fz.divide(dfz).plus_mutable(fzSquared.times(ffz).divide_mutable((fzSquared.sub(fz.times(ffz).times2_mutable()).plus_mutable(ffz.square())).times_mutable(dfz)));
