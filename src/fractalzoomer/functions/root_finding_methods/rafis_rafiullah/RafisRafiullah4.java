...
public class RafisRafiullah4 extends RafisRafiullahRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex combined_ddfz = temp.square().times_mutable(12);
