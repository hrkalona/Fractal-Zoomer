...
public class RafisRafiullahGeneralized8 extends RafisRafiullahRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex combined_ddfz = temp.sixth().times_mutable(56).plus_mutable(temp.square().times_mutable(180));
