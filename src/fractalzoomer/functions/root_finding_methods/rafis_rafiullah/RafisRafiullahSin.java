...
public class RafisRafiullahSin extends RafisRafiullahRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex temp2 = getSecondDerivativeArgument(complex[0], fz, dfz);

        Complex combined_ddfz = temp2.sin().negative_mutable();
