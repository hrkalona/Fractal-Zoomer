...
public class RafisRafiullahPoly extends RafisRafiullahRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex temp = getSecondDerivativeArgument(complex[0], fz, dfz);

        Complex combined_ddfz;

        if(usesComplexCoefficients) {
            combined_ddfz = temp.eighth().times_mutable(complex_coefficients[0].times(90)).plus_mutable(temp.seventh().times_mutable(complex_coefficients[1].times(72))).plus_mutable(temp.sixth().times_mutable(complex_coefficients[2].times(56))).plus_mutable(temp.fifth().times_mutable(complex_coefficients[3].times(42))).plus_mutable(temp.fourth().times_mutable(complex_coefficients[4].times(30))).plus_mutable(temp.cube().times_mutable(complex_coefficients[5].times(20))).plus_mutable(temp.square().times_mutable(complex_coefficients[6].times(12))).plus_mutable(temp.times(complex_coefficients[7].times(6))).plus_mutable(complex_coefficients[8].times(2));
        }
        else {
            combined_ddfz = temp.eighth().times_mutable(90 * coefficients[0]).plus_mutable(temp.seventh().times_mutable(72 * coefficients[1])).plus_mutable(temp.sixth().times_mutable(56 * coefficients[2])).plus_mutable(temp.fifth().times_mutable(42 * coefficients[3])).plus_mutable(temp.fourth().times_mutable(30 * coefficients[4])).plus_mutable(temp.cube().times_mutable(20 * coefficients[5])).plus_mutable(temp.square().times_mutable(12 * coefficients[6])).plus_mutable(temp.times(6 * coefficients[7])).plus_mutable(2 * coefficients[8]);
        }

        rafisRafiullahMethod(complex[0], fz, dfz, ddfz, combined_ddfz);
