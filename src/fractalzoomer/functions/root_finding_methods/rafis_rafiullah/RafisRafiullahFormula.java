...
public class RafisRafiullahFormula extends RafisRafiullahRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(Derivative.DERIVATIVE_METHOD == Derivative.DISABLED) {
            ...
            combined_ddfz = Derivative.numericalCentralDerivativeSecondOrder(fzTemp, fzdz, fzmdz);
        } else if (Derivative.DERIVATIVE_METHOD == Derivative.NUMERICAL_FORWARD) {
            if (parser.foundZ()) {
                parser.setZvalue(temp);
            }
            ...
            combined_ddfz = Derivative.numericalForwardDerivativeSecondOrder(fzTemp, fzdz, fz2dz);
            ...
            combined_ddfz = Derivative.numericalBackwardDerivativeSecondOrder(fzTemp, fzmdz, fzm2dz);
        }
