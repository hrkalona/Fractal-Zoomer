...
public class SteffensenGeneralized3 extends RootFindingMethods {
    ...
    public SteffensenGeneralized3(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    //orbit
    public SteffensenGeneralized3(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex ffz = temp.cube().sub_mutable(temp.times_mutable(2)).plus_mutable(2);
