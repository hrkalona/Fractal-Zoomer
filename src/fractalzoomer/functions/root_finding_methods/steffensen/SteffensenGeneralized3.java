...
public class SteffensenGeneralized3 extends SteffensenRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ffz = temp.cube().sub_mutable(temp.times2_mutable()).plus_mutable(2);
