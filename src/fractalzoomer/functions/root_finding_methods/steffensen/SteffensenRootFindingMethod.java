...
public abstract class SteffensenRootFindingMethod extends RootFindingMethods {
    ...
    public static Complex getFunctionArgument(Complex z, Complex fz) {
