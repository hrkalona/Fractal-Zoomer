...
public class AberthEhrlichGeneralized8 extends AberthEhrlichRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        for(int i = 0; i < degree; i++) {
            ...
            dfz[i] = complex[i].seventh().times_mutable(8).plus_mutable(complex[i].cube().times_mutable(60));
        }
