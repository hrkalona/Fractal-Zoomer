    ...
    public void function(Complex[] complex) {
        ...
        for(int i = 0; i < degree; i++) {
            if(usesComplexCoefficients) {
                ...
                dfz[i] = complex[i].ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(complex[i].eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(complex[i].seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(complex[i].sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(complex[i].fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(complex[i].fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(complex[i].cube().times_mutable(complex_coefficients[6].times(4))).plus_mutable(complex[i].square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(complex[i].times(complex_coefficients[8].times(2))).plus_mutable(complex_coefficients[9]);;
            }
            else {
