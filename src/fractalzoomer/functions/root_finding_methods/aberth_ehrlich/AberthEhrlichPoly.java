...
import fractalzoomer.functions.root_finding_methods.durand_kerner.DurandKernerPoly;
...
public class AberthEhrlichPoly extends AberthEhrlichRootFindingMethod {
    ...
    public AberthEhrlichPoly(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int user_out_coloring_algorithm, String outcoloring_formula, String[] user_outcoloring_conditions, String[] user_outcoloring_condition_formula, int in_coloring_algorithm, int user_in_coloring_algorithm, String incoloring_formula, String[] user_incoloring_conditions, String[] user_incoloring_condition_formula, boolean smoothing, int plane_type, double[] rotation_vals, double[] rotation_center, double[] coefficients, String user_plane, int user_plane_algorithm, String[] user_plane_conditions, String[] user_plane_condition_formula, double[] plane_transform_center, double plane_transform_angle, double plane_transform_radius, double[] plane_transform_scales, double[] plane_transform_wavelength, int waveType, double plane_transform_angle2, int plane_transform_sides, double plane_transform_amount, ArrayList<Double> inflections_re, ArrayList<Double> inflections_im, double inflectionsPower, int converging_smooth_algorithm, OrbitTrapSettings ots, StatisticsSettings sts, double[] durand_kerner_init_val, double[] coefficients_im, int root_initialization_method) {
        ...
        aberthEhrlichInitializationMethod = root_initialization_method;
    ...
    //orbit
    public AberthEhrlichPoly(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, double[] coefficients, String user_plane, int user_plane_algorithm, String[] user_plane_conditions, String[] user_plane_condition_formula, double[] plane_transform_center, double plane_transform_angle, double plane_transform_radius, double[] plane_transform_scales, double[] plane_transform_wavelength, int waveType, double plane_transform_angle2, int plane_transform_sides, double plane_transform_amount, ArrayList<Double> inflections_re, ArrayList<Double> inflections_im, double inflectionsPower, double[] durand_kerner_init_val, double[] coefficients_im, int root_initialization_method) {

        super(xCenter, yCenter, size, max_iterations, complex_orbit, plane_type, rotation_vals, rotation_center, user_plane, user_plane_algorithm, user_plane_conditions, user_plane_condition_formula,  plane_transform_center, plane_transform_angle, plane_transform_radius, plane_transform_scales, plane_transform_wavelength, waveType, plane_transform_angle2, plane_transform_sides, plane_transform_amount, inflections_re, inflections_im, inflectionsPower, DurandKernerPoly.getDeg(coefficients, coefficients_im));
    ...
    public void function(Complex[] complex) {
        ...
        for(int i = 0; i < degree; i++) {
            if(usesComplexCoefficients) {
                ...
                dfz[i] = complex[i].ninth().times_mutable(complex_coefficients[0].times(10)).plus_mutable(complex[i].eighth().times_mutable(complex_coefficients[1].times(9))).plus_mutable(complex[i].seventh().times_mutable(complex_coefficients[2].times(8))).plus_mutable(complex[i].sixth().times_mutable(complex_coefficients[3].times(7))).plus_mutable(complex[i].fifth().times_mutable(complex_coefficients[4].times(6))).plus_mutable(complex[i].fourth().times_mutable(complex_coefficients[5].times(5))).plus_mutable(complex[i].cube().times_mutable(complex_coefficients[6].times4())).plus_mutable(complex[i].square().times_mutable(complex_coefficients[7].times(3))).plus_mutable(complex[i].times(complex_coefficients[8].times2())).plus_mutable(complex_coefficients[9]);;
            }
            else {
                ...
                dfz[i] = complex[i].ninth().times_mutable(10 * coefficients[0]).plus_mutable(complex[i].eighth().times_mutable(9 * coefficients[1])).plus_mutable(complex[i].seventh().times_mutable(8 * coefficients[2])).plus_mutable(complex[i].sixth().times_mutable(7 * coefficients[3])).plus_mutable(complex[i].fifth().times_mutable(6 * coefficients[4])).plus_mutable(complex[i].fourth().times_mutable(5 * coefficients[5])).plus_mutable(complex[i].cube().times_mutable(4 * coefficients[6])).plus_mutable(complex[i].square().times_mutable(3 * coefficients[7])).plus_mutable(complex[i].times(2 * coefficients[8])).plus_mutable(coefficients[9]);
            }
        }
