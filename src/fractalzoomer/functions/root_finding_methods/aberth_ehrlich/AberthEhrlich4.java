...
public class AberthEhrlich4 extends AberthEhrlichRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        for(int i = 0; i < degree; i++) {
            fz[i] = complex[i].fourth().sub_mutable(1);
            dfz[i] = complex[i].cube().times4_mutable();
        }
