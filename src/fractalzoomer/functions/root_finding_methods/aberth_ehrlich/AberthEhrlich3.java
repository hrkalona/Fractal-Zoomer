...
public class AberthEhrlich3 extends AberthEhrlichRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        for(int i = 0; i < degree; i++) {
            fz[i] = complex[i].cube().sub_mutable(1);
            dfz[i] = complex[i].square().times_mutable(3);
        }
