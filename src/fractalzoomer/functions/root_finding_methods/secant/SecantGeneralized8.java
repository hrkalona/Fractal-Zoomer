...
public class SecantGeneralized8 extends RootFindingMethods {
    ...
    public SecantGeneralized8(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, int plane_type, double[] rotation_vals) {
    ...
    //orbit
    public SecantGeneralized8(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals) {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex fz1 = complex[0].eighth().plus(complex[0].fourth().times(15)).sub(16);
