...
public class SecantPoly extends RootFindingMethods {
  private double[] coefficients;
    ...
    public SecantPoly(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, int plane_type, double[] rotation_vals, double[] coefficients) {
    ...
    //orbit
    public SecantPoly(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] coefficients) {
