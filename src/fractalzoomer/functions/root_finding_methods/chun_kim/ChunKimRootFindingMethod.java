...
public abstract class ChunKimRootFindingMethod extends RootFindingMethods {
    ...
    public Complex chunKimMethod(Complex z, Complex fz, Complex dfz, Complex df_combined) {
        ...
        z.sub_mutable(fz.times(dfz.square().times_mutable(3).plus_mutable(2).sub_mutable(dfz.times(df_combined))).divide_mutable(dfz.plus(dfz.cube().times2_mutable()).plus_mutable(df_combined)));
    ...
    public static Complex chunKimMethod(Complex z, Complex fz, Complex dfz, Complex df_combined, Complex relaxation) {
        ...
        z.sub_mutable(fz.times(dfz.square().times_mutable(3).plus_mutable(2).sub_mutable(dfz.times(df_combined))).divide_mutable(dfz.plus(dfz.cube().times2_mutable()).plus_mutable(df_combined)).times_mutable(relaxation));
    ...
    public static Complex chunKimStep(Complex fz, Complex dfz, Complex df_combined) {
        ...
        return fz.times(dfz.square().times_mutable(3).plus_mutable(2).sub_mutable(dfz.times(df_combined))).divide_mutable(dfz.plus(dfz.cube().times2_mutable()).plus_mutable(df_combined));
