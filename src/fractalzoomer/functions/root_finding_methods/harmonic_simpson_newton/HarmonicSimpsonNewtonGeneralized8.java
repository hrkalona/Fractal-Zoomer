...
public class HarmonicSimpsonNewtonGeneralized8 extends HarmonicSimpsonNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex combined_dfz = temp.seventh().times_mutable(8).plus_mutable(temp.cube().times_mutable(60));

        Complex temp2 = complex[0].plus(temp).times_mutable(0.5);

        Complex combined_dfz2 = temp2.seventh().times_mutable(8).plus_mutable(temp2.cube().times_mutable(60));
