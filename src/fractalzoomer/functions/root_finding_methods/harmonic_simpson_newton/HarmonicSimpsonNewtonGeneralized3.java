...
public class HarmonicSimpsonNewtonGeneralized3 extends HarmonicSimpsonNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex fz = complex[0].cube().sub_mutable(complex[0].times2()).plus_mutable(2);
        Complex dfz = complex[0].square().times_mutable(3).sub_mutable(2);

        Complex temp = getDerivativeArgument(complex[0], fz, dfz);

        Complex combined_dfz = temp.square().times_mutable(3).sub_mutable(2);

        Complex temp2 = complex[0].plus(temp).times_mutable(0.5);

        Complex combined_dfz2 = temp2.square().times_mutable(3).sub_mutable(2);
