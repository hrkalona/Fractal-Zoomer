...
public class HarmonicSimpsonNewtonFormula extends HarmonicSimpsonNewtonRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        if(Derivative.DERIVATIVE_METHOD == Derivative.DISABLED) {
            ...
            combined_dfz2 = Derivative.numericalCentralDerivativeFirstOrder(fzdz, fzmdz);
        } else if (Derivative.DERIVATIVE_METHOD == Derivative.NUMERICAL_FORWARD) {
            if (parser.foundZ()) {
            ...
            combined_dfz2 = Derivative.numericalForwardDerivativeFirstOrder(fzTemp, fzdz);
            ...
            combined_dfz2 = Derivative.numericalBackwardDerivativeFirstOrder(fzTemp, fzmdz);
        }
