 ...
 * @author hrkalona2
 */
public class HouseholderSin extends RootFindingMethods {

    public HouseholderSin(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    //orbit
    public HouseholderSin(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex[] temp = complex[0].der012_sin();
