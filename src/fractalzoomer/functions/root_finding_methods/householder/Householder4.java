 ...
 * @author hrkalona2
 */
public class Householder4 extends RootFindingMethods {

    public Householder4(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    //orbit
    public Householder4(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, String user_plane) {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex ddfz = complex[0].square().times_mutable(12);

        complex[0].sub_mutable((fz.times_mutable(dfz.square().times_mutable(2).plus_mutable(fz.times(ddfz)))).divide_mutable(dfz.cube_mutable().times_mutable(2)));//householder
