...
public class MaheshweriPoly extends MaheshweriRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        maheshweriMethod(complex[0], fz, dfz, ffz);
