...
public abstract class EzzatiSaleki2RootFindingMethod extends RootFindingMethods {
    ...
    public Complex ezzatiSaleki2Method(Complex z, Complex fz, Complex dfz, Complex ffz) {
        ...
        z.sub_mutable(fz.divide(dfz)).plus_mutable(ffz.divide(dfz)).sub_mutable(fz.times(ffz).times_mutable(2).divide_mutable(fz.sub(ffz).times_mutable(dfz)));
        return z;
    ...
    public static Complex ezzatiSaleki2Method(Complex z, Complex fz, Complex dfz, Complex ffz, Complex relaxation) {
        ...
        z.sub_mutable(fz.divide(dfz).times_mutable(relaxation)).plus_mutable(ffz.divide(dfz).times_mutable(relaxation)).sub_mutable(fz.times(ffz).times_mutable(2).divide_mutable(fz.sub(ffz).times_mutable(dfz)).times_mutable(relaxation));
        return z;
    ...
    public static Complex ezzatiSaleki2Step(Complex fz, Complex dfz, Complex ffz) {
        ...
        return fz.divide(dfz).sub_mutable(ffz.divide(dfz)).plus_mutable(fz.times(ffz).times_mutable(2).divide_mutable(fz.sub(ffz).times_mutable(dfz)));
