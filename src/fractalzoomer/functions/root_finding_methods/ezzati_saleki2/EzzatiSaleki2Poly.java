...
public class EzzatiSaleki2Poly extends EzzatiSaleki2RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        ezzatiSaleki2Method(complex[0], fz, dfz, ffz);
