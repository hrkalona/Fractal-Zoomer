...
public class Broyden4 extends BroydenRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        complex[1] = complex[0].fourth().sub_mutable(1); //fz

        Complex zc = complex[0].plus(new Complex(1e-3, 1e-3));
        Complex fzc = zc.fourth().sub_mutable(1);
    ...
    public void function(Complex[] complex) {
        ...
        Complex newFZ = newZ.fourth().sub_mutable(1);;
