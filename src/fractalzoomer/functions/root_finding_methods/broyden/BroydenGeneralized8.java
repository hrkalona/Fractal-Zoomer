...
public class BroydenGeneralized8 extends BroydenRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        complex[1] = complex[0].eighth().plus_mutable(complex[0].fourth().times_mutable(15)).sub_mutable(16); //fz

        Complex zc = complex[0].plus(new Complex(1e-3, 1e-3));
        Complex fzc = zc.eighth().plus_mutable(zc.fourth().times_mutable(15)).sub_mutable(16);
    ...
    public void function(Complex[] complex) {
        ...
        Complex newFZ = newZ.eighth().plus_mutable(newZ.fourth().times_mutable(15)).sub_mutable(16);
