...
public class BroydenGeneralized3 extends BroydenRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        complex[1] = complex[0].cube().sub_mutable(complex[0].times2()).plus_mutable(2); //fz

        Complex zc = complex[0].plus(new Complex(1e-3, 1e-3));
        Complex fzc = zc.cube().sub_mutable(zc.times2()).plus_mutable(2);
    ...
    public void function(Complex[] complex) {
        ...
        Complex newFZ = newZ.cube().sub_mutable(newZ.times2()).plus_mutable(2);
    ...
    public Complex evaluateFunction(Complex z, Complex c) {
        return z.cube().sub_mutable(z.times2()).plus_mutable(2);
    }
