...
public class Broyden3 extends BroydenRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        complex[1] = complex[0].cube().sub_mutable(1); //fz

        Complex zc = complex[0].plus(new Complex(1e-3, 1e-3));
        Complex fzc = zc.cube().sub_mutable(1);
    ...
    public void function(Complex[] complex) {
        ...
        Complex newFZ = newZ.cube().sub_mutable(1);
