...
public class BroydenPoly extends BroydenRootFindingMethod {
    ...
    public Complex[] initialize(Complex pixel) {
        ...
        if(usesComplexCoefficients) {
            complex[1] = complex[0].tenth().times_mutable(complex_coefficients[0]).plus_mutable(complex[0].ninth().times_mutable(complex_coefficients[1])).plus_mutable(complex[0].eighth().times_mutable(complex_coefficients[2])).plus_mutable(complex[0].seventh().times_mutable(complex_coefficients[3])).plus_mutable(complex[0].sixth().times_mutable(complex_coefficients[4])).plus_mutable(complex[0].fifth().times_mutable(complex_coefficients[5])).plus_mutable(complex[0].fourth().times_mutable(complex_coefficients[6])).plus_mutable(complex[0].cube().times_mutable(complex_coefficients[7])).plus_mutable(complex[0].square().times_mutable(complex_coefficients[8])).plus_mutable(complex[0].times(complex_coefficients[9])).plus_mutable(complex_coefficients[10]);
        }
        else {
            complex[1] = complex[0].tenth().times_mutable(coefficients[0]).plus_mutable(complex[0].ninth().times_mutable(coefficients[1])).plus_mutable(complex[0].eighth().times_mutable(coefficients[2])).plus_mutable(complex[0].seventh().times_mutable(coefficients[3])).plus_mutable(complex[0].sixth().times_mutable(coefficients[4])).plus_mutable(complex[0].fifth().times_mutable(coefficients[5])).plus_mutable(complex[0].fourth().times_mutable(coefficients[6])).plus_mutable(complex[0].cube().times_mutable(coefficients[7])).plus_mutable(complex[0].square().times_mutable(coefficients[8])).plus_mutable(complex[0].times(coefficients[9])).plus_mutable(coefficients[10]);
        }

        Complex zc = complex[0].plus(new Complex(1e-3, 1e-3));

        Complex fzc;
        if(usesComplexCoefficients) {
            fzc = zc.tenth().times_mutable(complex_coefficients[0]).plus_mutable(zc.ninth().times_mutable(complex_coefficients[1])).plus_mutable(zc.eighth().times_mutable(complex_coefficients[2])).plus_mutable(zc.seventh().times_mutable(complex_coefficients[3])).plus_mutable(zc.sixth().times_mutable(complex_coefficients[4])).plus_mutable(zc.fifth().times_mutable(complex_coefficients[5])).plus_mutable(zc.fourth().times_mutable(complex_coefficients[6])).plus_mutable(zc.cube().times_mutable(complex_coefficients[7])).plus_mutable(zc.square().times_mutable(complex_coefficients[8])).plus_mutable(zc.times(complex_coefficients[9])).plus_mutable(complex_coefficients[10]);
        }
        else {
            fzc = zc.tenth().times_mutable(coefficients[0]).plus_mutable(zc.ninth().times_mutable(coefficients[1])).plus_mutable(zc.eighth().times_mutable(coefficients[2])).plus_mutable(zc.seventh().times_mutable(coefficients[3])).plus_mutable(zc.sixth().times_mutable(coefficients[4])).plus_mutable(zc.fifth().times_mutable(coefficients[5])).plus_mutable(zc.fourth().times_mutable(coefficients[6])).plus_mutable(zc.cube().times_mutable(coefficients[7])).plus_mutable(zc.square().times_mutable(coefficients[8])).plus_mutable(zc.times(coefficients[9])).plus_mutable(coefficients[10]);
        }
        complex[2] = getInitialJacobianApproximation(complex[0], zc, complex[1], fzc); //B
    ...
    public void function(Complex[] complex) {
        ...
        Complex newZ = broydenMethod(complex[0], complex[1], complex[2]);
        Complex newFZ;
        if(usesComplexCoefficients) {
            newFZ = newZ.tenth().times_mutable(complex_coefficients[0]).plus_mutable(newZ.ninth().times_mutable(complex_coefficients[1])).plus_mutable(newZ.eighth().times_mutable(complex_coefficients[2])).plus_mutable(newZ.seventh().times_mutable(complex_coefficients[3])).plus_mutable(newZ.sixth().times_mutable(complex_coefficients[4])).plus_mutable(newZ.fifth().times_mutable(complex_coefficients[5])).plus_mutable(newZ.fourth().times_mutable(complex_coefficients[6])).plus_mutable(newZ.cube().times_mutable(complex_coefficients[7])).plus_mutable(newZ.square().times_mutable(complex_coefficients[8])).plus_mutable(newZ.times(complex_coefficients[9])).plus_mutable(complex_coefficients[10]);
        }
        else {
            newFZ = newZ.tenth().times_mutable(coefficients[0]).plus_mutable(newZ.ninth().times_mutable(coefficients[1])).plus_mutable(newZ.eighth().times_mutable(coefficients[2])).plus_mutable(newZ.seventh().times_mutable(coefficients[3])).plus_mutable(newZ.sixth().times_mutable(coefficients[4])).plus_mutable(newZ.fifth().times_mutable(coefficients[5])).plus_mutable(newZ.fourth().times_mutable(coefficients[6])).plus_mutable(newZ.cube().times_mutable(coefficients[7])).plus_mutable(newZ.square().times_mutable(coefficients[8])).plus_mutable(newZ.times(coefficients[9])).plus_mutable(coefficients[10]);
        }
        complex[2] = advanceJacobianApproximation(complex[2], newZ, complex[0], newFZ, complex[1]);
        complex[0] = newZ;
        complex[1] = newFZ;
