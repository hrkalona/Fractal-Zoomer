...
public abstract class TraubOstrowskiRootFindingMethod extends RootFindingMethods {
    ...
    public Complex traubOstrowskiMethod(Complex z, Complex fz, Complex dfz, Complex fnewtons) {
        ...
        z.sub_mutable((fz.times(fnewtons).sub_mutable(fz.square())).divide_mutable(dfz.times(2).times_mutable(fnewtons).sub_mutable(fz.times(dfz))));
    ...
    public static Complex traubOstrowskiMethod(Complex z, Complex fz, Complex dfz, Complex fnewtons, Complex relaxation) {
        ...
        z.sub_mutable((fz.times(fnewtons).sub_mutable(fz.square())).divide_mutable(dfz.times(2).times_mutable(fnewtons).sub_mutable(fz.times(dfz))).times_mutable(relaxation));
