...
public class ChangBumChun2Poly extends ChangBumChun2RootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        changbumChun2Method(complex[0], fz, dfz, ffz);
