...
public class SzegediButterfly2 extends Julia {
    ...
    public SzegediButterfly2(double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, int out_coloring_algorithm, int in_coloring_algorithm, boolean smoothing, boolean periodicity_checking, int plane_type, double[] rotation_vals, double xJuliaCenter, double yJuliaCenter) {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = new Complex(temp2 * temp2 - Math.sqrt(complex[0].absIm()), temp * temp - Math.sqrt(complex[0].absRe())).plus_mutable(complex[1]);
