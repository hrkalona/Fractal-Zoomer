...
public abstract class MagnetPatakiType extends Julia {
    ...
    @Override
    public GenericComplex[] initializeReferencePrecalculationData(GenericComplex c, Location loc, boolean useBigNum, boolean lowPrecReferenceOrbitNeeded, boolean deepZoom) {
