 ...
 * @author hrkalona
 */
public class Magnet14 extends MagnetType {
    ...
    public void function(Complex[] complex) {
        ...
        complex[0] = (complex[0].square().plus_mutable(complex[1].sub(1))).divide_mutable(complex[0].times(2).plus_mutable(complex[1].sub(2))).fourth_mutable();
