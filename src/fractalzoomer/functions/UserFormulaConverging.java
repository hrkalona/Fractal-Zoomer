...
public class UserFormulaConverging extends Julia {
  ...
  private Parser parser;
    ...
    public UserFormulaConverging(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, String user_formula, String user_plane, double xJuliaCenter, double yJuliaCenter) {
