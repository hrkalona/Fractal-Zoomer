...
public class MandelbrotCubed extends Julia {
  ...
  private MandelVariation type2;
    ...
    public MandelbrotCubed(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double[] rotation_center, boolean burning_ship, boolean mandel_grass, double[] mandel_grass_vals, String user_plane, double xJuliaCenter, double yJuliaCenter) {
