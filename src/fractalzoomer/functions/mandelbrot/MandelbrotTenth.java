...
public class MandelbrotTenth extends Julia {
  ...
  private MandelVariation type2;
    ...
    public MandelbrotTenth(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean burning_ship, boolean mandel_grass, double[] mandel_grass_vals, double xJuliaCenter, double yJuliaCenter) {
