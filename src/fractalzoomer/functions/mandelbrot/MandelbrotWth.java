...
public class MandelbrotWth extends Julia {
  ...
  private MandelVariation type;
    ...
    public MandelbrotWth(double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, int out_coloring_algorithm, int in_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean burning_ship, double[] z_exponent, double xJuliaCenter, double yJuliaCenter) {
    ...
    //orbit
    public MandelbrotWth(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals, boolean init_value, double[] initial_vals, boolean burning_ship, double[] z_exponent) {
    ...
    public MandelbrotWth(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean burning_ship, double[] z_exponent, double xJuliaCenter, double yJuliaCenter) {
