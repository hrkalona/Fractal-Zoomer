package fractalzoomer.functions.schroder;
...
public class SchroderSin extends RootFindingMethods {
    ...
    public SchroderSin(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, int plane_type, double[] rotation_vals) {
    ...
    //orbit
    public SchroderSin(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals) {
