...
public class Formula22 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        (complex[0].divide_mutable(complex[1])).abs_mutable().plus_mutable(complex[1]);
