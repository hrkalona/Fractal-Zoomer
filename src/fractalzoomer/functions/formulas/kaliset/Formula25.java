...
public class Formula25 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        (complex[0].abs_mutable()).cube_mutable().reciprocal_mutable().plus_mutable(complex[1]);
