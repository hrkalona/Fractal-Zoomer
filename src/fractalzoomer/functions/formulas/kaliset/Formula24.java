...
public class Formula24 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        (complex[0].abs_mutable()).divide_mutable(complex[1]).plus_mutable(complex[1]);
