...
public class Formula26 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        (complex[0].cube_mutable()).abs_mutable().reciprocal_mutable().plus_mutable(complex[1]);
