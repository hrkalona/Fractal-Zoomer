...
public class Formula28 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0].square_mutable().times_mutable(complex[1]);
        complex[0].plus_mutable(complex[0].reciprocal());
