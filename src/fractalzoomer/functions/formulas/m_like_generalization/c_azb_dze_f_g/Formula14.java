...
public class Formula14 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].times(2).sub_mutable(complex[0].square())).times_mutable(complex[1]).plus_mutable(1)).cube_mutable();
