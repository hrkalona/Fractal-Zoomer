...
public class Formula16 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].sub(complex[0].square())).times_mutable(complex[1]).plus_mutable(1)).cube_mutable();
