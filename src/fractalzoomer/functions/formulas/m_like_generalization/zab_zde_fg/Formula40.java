...
public class Formula40 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].tenth().plus_mutable(complex[1])).divide_mutable(complex[0].eighth().plus_mutable(complex[1]))).plus_mutable(complex[1]).sub_mutable(2);
