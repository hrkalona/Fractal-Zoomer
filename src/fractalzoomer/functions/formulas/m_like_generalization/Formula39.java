...
public class Formula39 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = complex[0].square().times_mutable((complex[0].reciprocal()).exp()).plus_mutable(complex[1]);
