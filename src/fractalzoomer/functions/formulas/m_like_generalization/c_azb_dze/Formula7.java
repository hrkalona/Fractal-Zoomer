...
public class Formula7 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = (((complex[0].square()).reciprocal_mutable().times_mutable(2)).sub_mutable((complex[0].fourth()).reciprocal_mutable())).times_mutable(complex[1]);
