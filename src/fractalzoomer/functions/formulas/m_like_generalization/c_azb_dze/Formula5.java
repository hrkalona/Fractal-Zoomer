...
public class Formula5 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].fifth()).sub_mutable(complex[0].times(5))).times_mutable(complex[1]);
