...
public class Formula6 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].square().times_mutable(2)).sub_mutable(complex[0].fourth())).times_mutable(complex[1]);
