...
public class Formula4 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].reciprocal()).times_mutable(5)).plus_mutable(complex[0].fifth()).times_mutable(complex[1]);
