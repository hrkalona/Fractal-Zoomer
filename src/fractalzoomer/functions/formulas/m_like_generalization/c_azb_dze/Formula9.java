...
public class Formula9 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].cube()).reciprocal_mutable().times_mutable(-3).plus_mutable((complex[0].ninth()).reciprocal_mutable())).times_mutable(complex[1]);
