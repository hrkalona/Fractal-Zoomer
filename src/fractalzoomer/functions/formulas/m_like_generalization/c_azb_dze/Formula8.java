...
public class Formula8 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = ((complex[0].reciprocal().times_mutable(5)).sub_mutable((complex[0].fifth()).reciprocal_mutable())).times_mutable(complex[1]);
