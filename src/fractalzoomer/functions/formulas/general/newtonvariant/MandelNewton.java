...
public class MandelNewton extends Julia {
    ...
    public void function(Complex[] complex) {
        ...
        Complex fz = complex[0].square().plus_mutable(1);
        Complex dfz = complex[0].times(2);
