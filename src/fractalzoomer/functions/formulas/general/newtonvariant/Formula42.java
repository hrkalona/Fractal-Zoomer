...
public class Formula42 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex fz = complex[0].cube().plus_mutable(complex[1]);
        Complex fz2 = complex[0].times(3);
