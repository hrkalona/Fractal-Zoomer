...
public class Formula45 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex fz = complex[0].eighth().plus_mutable(complex[1]);
        Complex fz2 = complex[0].sixth().times_mutable(8);

        complex[0].sub_mutable(fz.divide_mutable(fz2));
