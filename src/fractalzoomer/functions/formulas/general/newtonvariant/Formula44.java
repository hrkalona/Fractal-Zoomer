...
public class Formula44 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex fz = complex[0].fifth().plus_mutable(complex[1]);
        Complex fz2 = complex[0].cube().times_mutable(5);
