...
public class Formula43 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        Complex fz = complex[0].fourth().plus_mutable(complex[1]);
        Complex fz2 = complex[0].square().times_mutable(4);
