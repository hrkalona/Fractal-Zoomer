 ...
 */
package fractalzoomer.functions.formulas.general.mathtype;
...
public class Formula35 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = (complex[0].cos().times_mutable(2)).r_sub_mutable(2).plus_mutable(complex[1]);
