...
public class Formula36 extends Julia {
    ...
    protected void function(Complex[] complex) {
        ...
        complex[0] = (complex[0].cosh().times_mutable(2)).sub_mutable(2).plus_mutable(complex[1]);
