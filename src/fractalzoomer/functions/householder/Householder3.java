...
public class Householder3 extends RootFindingMethods {
    ...
    public Householder3(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int in_coloring_algorithm, int plane_type, double[] rotation_vals) {
