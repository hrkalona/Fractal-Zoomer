...
public class UserFormulaIterationBasedEscaping extends Julia {
    ...
    public UserFormulaIterationBasedEscaping(double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, String bailout_test_user_formula, String bailout_test_user_formula2, int bailout_test_comparison, double n_norm, int out_coloring_algorithm, int user_out_coloring_algorithm, String outcoloring_formula, String[] user_outcoloring_conditions, String[] user_outcoloring_condition_formula, int in_coloring_algorithm, int user_in_coloring_algorithm, String incoloring_formula, String[] user_incoloring_conditions, String[] user_incoloring_condition_formula, boolean smoothing, boolean periodicity_checking, int plane_type, boolean apply_plane_on_julia, double[] rotation_vals, double[] rotation_center, String[] user_formula, String user_plane, int user_plane_algorithm, String[] user_plane_conditions, String[] user_plane_condition_formula, double[] plane_transform_center, double plane_transform_angle, double plane_transform_radius, double[] plane_transform_scales, double plane_transform_angle2, int plane_transform_sides, double plane_transform_amount, int escaping_smooth_algorithm, double xJuliaCenter, double yJuliaCenter) {
    ...
    public UserFormulaIterationBasedEscaping(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, boolean apply_plane_on_julia, double[] rotation_vals, double[] rotation_center, String[] user_formula, String user_plane, int user_plane_algorithm, String[] user_plane_conditions, String[] user_plane_condition_formula, double[] plane_transform_center, double plane_transform_angle, double plane_transform_radius, double[] plane_transform_scales, double plane_transform_angle2, int plane_transform_sides, double plane_transform_amount, double xJuliaCenter, double yJuliaCenter) {
        ...
        if(iterations % 4 == 0) {
            ...
            for(int i = 0; i < Parser.EXTRA_VARS; i++) {
                if(parser[2].foundVar(i)) {
                    parser[2].setVarsvalue(i, vars[i]);
                }
            }
            ...
            for(int i = 0; i < Parser.EXTRA_VARS; i++) {
                if(parser[3].foundVar(i)) {
                    parser[3].setVarsvalue(i, vars[i]);
                }
            }
    ...
    private void setInitVariables(Complex start, Complex zold, Complex zold2) {
        ...
        if(parser[2].foundCenter()) {
            parser[2].setCentervalue(new Complex(xCenter, yCenter));
        }

        if(parser[3].foundCenter()) {
            parser[3].setCentervalue(new Complex(xCenter, yCenter));
        }
        ...
        if(parser[2].foundSize()) {
            parser[2].setSizevalue(new Complex(size, 0));
        }

        if(parser[3].foundSize()) {
            parser[3].setSizevalue(new Complex(size, 0));
        }
    }
}
