package fractalzoomer.functions.barnsley;
 ...
 * @author hrkalona
 */
public class Barnsley3 extends Julia {

    public Barnsley3(double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, int out_coloring_algorithm, int in_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals) {
    ...
    public Barnsley3(double xCenter, double yCenter, double size, int max_iterations, int bailout_test_algorithm, double bailout, int out_coloring_algorithm, int in_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, double xJuliaCenter, double yJuliaCenter) {
    ...
    //orbit
    public Barnsley3(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals) {
    ...
    public Barnsley3(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, int plane_type, double[] rotation_vals, double xJuliaCenter, double yJuliaCenter) {
    ...
    protected void function(Complex[] complex) {
        ...
        double temp = complex[0].getRe();

        complex[0] = temp > 0 ? complex[0].square().sub(1) : complex[0].square().plus(new Complex(complex[1].getRe() * temp, complex[1].getIm() * temp)).sub(1);
