...
public class GrayCodeCurve {

    public static int defaultCurve(int x, int y) {
        return xyToGray(1073741824, x, y);
    }

    // Returns the Gray code curve index for a given (x, y) coordinate
    public static int xyToGray(int n, int x, int y) {
        int index = 0;
        int s = n / 2;
    ...
    public static void main(String[] args) throws IOException {
        ...
        int hilbertIndex = xyToGray(n, x, y);
        System.out.println("Gray Index: " + hilbertIndex);
...
//            }
        ...
        ImageIO.write(a, "png", new File("graycode.png"));
