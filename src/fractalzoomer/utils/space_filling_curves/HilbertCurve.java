...
public class HilbertCurve {
    ...
    public static int defaultCurve(int x, int y) {
        return xyToHilbert(1073741824, x, y);
    }

    // Returns the Hilbert curve index for a given (x, y) coordinate
    ...
    public static void main(String[] args) throws IOException {
        ...
        int hilbertIndex = xyToHilbert(n, x, y);
        System.out.println("Hilbert Index: " + hilbertIndex);
        ...
        ImageIO.write(a, "png", new File("hilbert.png"));
