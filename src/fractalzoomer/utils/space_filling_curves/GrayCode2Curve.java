...
public class GrayCode2Curve {

    // Returns the Gray code curve index for a given (x, y) coordinate
    public static int xyToGray2(int n, int x, int y) {
        int index = 0;
        int s = n / 2;
    ...
    public static void main(String[] args) throws IOException {
        ...
        int hilbertIndex = xyToGray2(n, x, y);
        System.out.println("Gray2 Index: " + hilbertIndex);
...
//            }
        ...
        ImageIO.write(a, "png", new File("graycode2.png"));
