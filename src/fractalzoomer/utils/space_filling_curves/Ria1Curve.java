...
public class Ria1Curve {

    public static int xyToRia1(int n, int x, int y) {
        int index = 0;
        int s = n / 2;
...
//                    x = n - 1 - x;
    ...
    public static void main(String[] args) throws IOException {
        ...
        int hilbertIndex = xyToRia1(n, x, y);
        System.out.println("Ria 1 Index: " + hilbertIndex);
...
//            }
        ...
        ImageIO.write(a, "png", new File("ria1.png"));
