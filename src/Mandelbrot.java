...
public class Mandelbrot extends Julia {
  ...
  //private boolean mandelbrot_optimization;

    public Mandelbrot(double xCenter, double yCenter, double size, int max_iterations, int bailout, int out_coloring_algorithm, boolean periodicity_checking, boolean inverse_plane, boolean burning_ship) {
        ...
        //this.mandelbrot_optimization = mandelbrot_optimization;
    ...
    public Mandelbrot(double xCenter, double yCenter, double size, int max_iterations, int bailout, int out_coloring_algorithm, boolean periodicity_checking, boolean inverse_plane, boolean burning_ship, double xJuliaCenter, double yJuliaCenter) {
    ...
    //orbit
    public Mandelbrot(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, boolean inverse_plane, boolean burning_ship) {
    ...
    public Mandelbrot(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, boolean inverse_plane, boolean burning_ship, double xJuliaCenter, double yJuliaCenter) {
    ...
    protected Complex function(Complex[] complex) {
        ...
        return burning_ship ? new Complex(complex[0].absRe(), complex[0].absIm()).square().plus(complex[1]) : complex[0].square().plus(complex[1]);
