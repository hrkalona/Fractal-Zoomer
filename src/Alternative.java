 ...
 * @author hrkalona
 */
public class Alternative extends ThreadPaint {
  ...
  private double color_intensity;
    ...
    public Alternative(int FROMx, int TOx, int FROMy, int TOy, int max_iterations, double[][] image_iterations, MainWindow ptr, Color fractal_color, int out_coloring_algorithm, double color_intensity, BufferedImage image, int color_cycling_location) {
