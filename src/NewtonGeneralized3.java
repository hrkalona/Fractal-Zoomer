 ...
 * @author hrkalona
 */
public class NewtonGeneralized3 extends Fractal {
  private double convergent_bailout;

    public NewtonGeneralized3(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, boolean inverse_plane) {
    ...
    //orbit
    public NewtonGeneralized3(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, boolean inverse_plane) {
    ...
    protected Complex function(Complex[] complex) {
        ...
        Complex fz = complex[0].cube().sub(complex[0].timesNormal(2)).plusNormal(2);
        Complex dfz = complex[0].square().timesNormal(3).subNormal(2);
