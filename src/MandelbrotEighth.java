...
public class MandelbrotEighth extends Julia {
  private MandelVariation type;
    ...
    public MandelbrotEighth(double xCenter, double yCenter, double size, int max_iterations, double bailout, int out_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean perturbation, double[] perturbation_vals, boolean burning_ship) {
    ...
    public MandelbrotEighth(double xCenter, double yCenter, double size, int max_iterations, double bailout, int out_coloring_algorithm, boolean periodicity_checking, int plane_type, double[] rotation_vals, boolean burning_ship, double xJuliaCenter, double yJuliaCenter) {
