 ...
 * @author hrkalona
 */
public class NewtonGeneralized8 extends Fractal {
  private double convergent_bailout;

    public NewtonGeneralized8(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, boolean inverse_plane) {
    ...
    //orbit
    public NewtonGeneralized8(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, boolean inverse_plane) {
    ...
    protected Complex function(Complex[] complex) {
        ...
        Complex fz = complex[0].eighth().plus(complex[0].fourth().timesNormal(15)).subNormal(16);
        Complex dfz = complex[0].seventh().timesNormal(8).plus(complex[0].cube().timesNormal(60));
