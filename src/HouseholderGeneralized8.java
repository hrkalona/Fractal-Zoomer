...
public class HouseholderGeneralized8 extends RootFindingMethods {
    ...
    public HouseholderGeneralized8(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, int plane_type, double[] rotation_vals) {
