 ...
 * @author hrkalona
 */
public class Newton3 extends Fractal {
  private double convergent_bailout;

    public Newton3(double xCenter, double yCenter, double size, int max_iterations, int out_coloring_algorithm, boolean inverse_plane) {
    ...
    //orbit
    public Newton3(double xCenter, double yCenter, double size, int max_iterations, ArrayList<Complex> complex_orbit, boolean inverse_plane) {
    ...
    protected Complex function(Complex[] complex) {
        ...
        Complex fz = complex[0].cube().subNormal(1);
        Complex dfz = complex[0].square().timesNormal(3);
