...
public final class SuperSimplexNoiseGenerator implements SeededNoiseGenerator {
    ...
    public double evaluateNoise(double x, double y, long seed) {
        switch (variant2D) {
            case IMPROVE_X: return OpenSimplex2S.noise2_ImproveX(seed, x, y);
            case CLASSIC: return OpenSimplex2S.noise2(seed, x, y);
        };
        return 0;
    }
    ...
    public double evaluateNoise(double x, double y, double z, long seed) {
        switch (variant3D) {
            case IMPROVE_XY: return OpenSimplex2S.noise3_ImproveXY(seed, x, y, z);
            case IMPROVE_XZ: return OpenSimplex2S.noise3_ImproveXZ(seed, x, y, z);
            case CLASSIC: return OpenSimplex2S.noise3_Fallback(seed, x, y, z);
        };
        return 0 ;
    }
    ...
    public double evaluateNoise(double x, double y, double z, double w, long seed) {
        switch (variant4D) {
            case IMPROVE_XY_IMPROVE_ZW: return OpenSimplex2S.noise4_ImproveXY_ImproveZW(seed, x, y, z, w);
            case IMPROVE_XYZ_IMPROVE_XY: return OpenSimplex2S.noise4_ImproveXYZ_ImproveXY(seed, x, y, z, w);
            case IMPROVE_XYZ_IMPROVE_XZ: return OpenSimplex2S.noise4_ImproveXYZ_ImproveXZ(seed, x, y, z, w);
            case IMRPOVE_XYZ: return OpenSimplex2S.noise4_ImproveXYZ(seed, x, y, z, w);
            case CLASSIC: return OpenSimplex2S.noise4_Fallback(seed, x, y, z, w);
        };
        return 0;
    }
