 ...
 * @author hrkalona
 */
public class CyclicRedCyan extends ThreadPaint {
  ...
  private double color_intensity;
    ...
    public CyclicRedCyan(int FROMx, int TOx, int FROMy, int TOy, int max_iterations, double[][] image_iterations, MainWindow ptr, Color fractal_color, BufferedImage image, int out_coloring_algorithm, double color_intensity, int color_cycling_location) {
