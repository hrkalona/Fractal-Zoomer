 ...
 * @author hrkalona
 */
public class HotCold extends ThreadDraw {
  ...
  private double color_intensity;
    ...
    public HotCold(int FROMx, int TOx, int FROMy, int TOy, int max_iterations,  MainWindow ptr, Color fractal_color, BufferedImage image, int out_coloring_algorithm, double color_intensity, int color_cycling_location) {
    ...
    public HotCold(int FROMx, int TOx, int FROMy, int TOy, int max_iterations,  MainWindow ptr, BufferedImage image, Color fractal_color, int out_coloring_algorithm, double color_intensity, int color_cycling_location, boolean[] filters) {
