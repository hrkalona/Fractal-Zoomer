 ...
 * @author hrkalona2
 */
public class SmoothBinaryDecompositionMagnet1 extends SmoothBinaryDecomposition {
  protected double log_convergent_bailout;

    public SmoothBinaryDecompositionMagnet1(double log_bailout_squared, double log_convergent_bailout) {
