 ...
 * @author hrkalona2
 */
public class SmoothEscapeTimeGaussianInteger4Magnet2 extends OutColorAlgorithm {
  protected double log_convergent_bailout;

    
    public SmoothEscapeTimeGaussianInteger4Magnet2(double log_convergent_bailout) {
    ...
    public double getResult(Object[] object) {
        ...
        return Math.abs((Integer)object[0] +  temp.getRe() + temp.getIm() + 100800 + temp3);
